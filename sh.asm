...
00000f88 <close>:
SYSCALL(close)
     f88:	b8 17 00 00 00       	mov    $0x17,%eax
     f8d:	cd 40                	int    $0x40
     f8f:	c3                   	ret    
...
00000fa8 <mknod>:
SYSCALL(mknod)
     fa8:	b8 13 00 00 00       	mov    $0x13,%eax
     fad:	cd 40                	int    $0x40
     faf:	c3                   	ret    

00000fb0 <unlink>:
SYSCALL(unlink)
     fb0:	b8 14 00 00 00       	mov    $0x14,%eax
     fb5:	cd 40                	int    $0x40
     fb7:	c3                   	ret    
...
00001000 <procstat>:
SYSCALL(procstat)
    1000:	b8 0f 00 00 00       	mov    $0xf,%eax
    1005:	cd 40                	int    $0x40
    1007:	c3                   	ret    

00001008 <set_priority>:
SYSCALL(set_priority)
    1008:	b8 10 00 00 00       	mov    $0x10,%eax
    100d:	cd 40                	int    $0x40
    100f:	c3                   	ret    
