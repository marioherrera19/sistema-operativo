...
00003c48 <write>:
SYSCALL(write)
    3c48:	b8 12 00 00 00       	mov    $0x12,%eax
    3c4d:	cd 40                	int    $0x40
    3c4f:	c3                   	ret    

00003c50 <close>:
SYSCALL(close)
    3c50:	b8 17 00 00 00       	mov    $0x17,%eax
    3c55:	cd 40                	int    $0x40
    3c57:	c3                   	ret    
...
00003c68 <open>:
SYSCALL(open)
    3c68:	b8 11 00 00 00       	mov    $0x11,%eax
    3c6d:	cd 40                	int    $0x40
    3c6f:	c3                   	ret    

00003c70 <mknod>:
SYSCALL(mknod)
    3c70:	b8 13 00 00 00       	mov    $0x13,%eax
    3c75:	cd 40                	int    $0x40
    3c77:	c3                   	ret    

00003c78 <unlink>:
SYSCALL(unlink)
    3c78:	b8 14 00 00 00       	mov    $0x14,%eax
    3c7d:	cd 40                	int    $0x40
    3c7f:	c3                   	ret    
...
00003c88 <link>:
SYSCALL(link)
    3c88:	b8 15 00 00 00       	mov    $0x15,%eax
    3c8d:	cd 40                	int    $0x40
    3c8f:	c3                   	ret    

00003c90 <mkdir>:
SYSCALL(mkdir)
    3c90:	b8 16 00 00 00       	mov    $0x16,%eax
    3c95:	cd 40                	int    $0x40
    3c97:	c3                   	ret    
...
00003cc8 <procstat>:
SYSCALL(procstat)
    3cc8:	b8 0f 00 00 00       	mov    $0xf,%eax
    3ccd:	cd 40                	int    $0x40
    3ccf:	c3                   	ret    

00003cd0 <set_priority>:
SYSCALL(set_priority)
    3cd0:	b8 10 00 00 00       	mov    $0x10,%eax
    3cd5:	cd 40                	int    $0x40
    3cd7:	c3                   	ret    
