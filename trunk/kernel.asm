...
8010011f:	e8 d7 49 00 00       	call   80104afb <sleep>
      goto loop;
...
8010029d:	e8 45 49 00 00       	call   80104be7 <wakeup>
...
80100776:	e8 4e 63 00 00       	call   80106ac9 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 42 63 00 00       	call   80106ac9 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 36 63 00 00       	call   80106ac9 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 29 63 00 00       	call   80106ac9 <uartputc>
  cgaputc(c);
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 c2 44 00 00       	call   80104cb1 <procdump>
      break;
...
801008f7:	e8 eb 42 00 00       	call   80104be7 <wakeup>
        }
      }
      break;
...
8010098a:	e8 6c 41 00 00       	call   80104afb <sleep>
...
80100b7b:	e8 8d 70 00 00       	call   80107c0d <setupkvm>
...
80100c14:	e8 c6 73 00 00       	call   80107fdf <allocuvm>
...
80100c51:	e8 9a 72 00 00       	call   80107ef0 <loaduvm>
...
80100cbc:	e8 1e 73 00 00       	call   80107fdf <allocuvm>
...
80100ce0:	e8 1e 75 00 00       	call   80108203 <clearpteu>
  sp = sz;
...
80100d0f:	e8 d0 45 00 00       	call   801052e4 <strlen>
...
80100d2d:	e8 b2 45 00 00       	call   801052e4 <strlen>
...
80100d57:	e8 5b 76 00 00       	call   801083b7 <copyout>
...
80100df7:	e8 bb 75 00 00       	call   801083b7 <copyout>
...
80100e4e:	e8 43 44 00 00       	call   80105296 <safestrcpy>
...
80100ea0:	e8 59 6e 00 00       	call   80107cfe <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 c5 72 00 00       	call   80108175 <freevm>
  return 0;
...
80100ee2:	e8 8e 72 00 00       	call   80108175 <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 bd 84 10 	movl   $0x801084bd,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f15:	e8 dc 3e 00 00       	call   80104df6 <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 e9 3e 00 00       	call   80104e17 <acquire>
...
80100f52:	e8 22 3f 00 00       	call   80104e79 <release>
      return f;
...
80100f70:	e8 04 3f 00 00       	call   80104e79 <release>
  return 0;
...
80100f89:	e8 89 3e 00 00       	call   80104e17 <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 c4 84 10 80 	movl   $0x801084c4,(%esp)
...
80100fba:	e8 ba 3e 00 00       	call   80104e79 <release>
  return f;
...
80100fd1:	e8 41 3e 00 00       	call   80104e17 <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 cc 84 10 80 	movl   $0x801084cc,(%esp)
...
8010100c:	e8 68 3e 00 00       	call   80104e79 <release>
    return;
...
80101056:	e8 1e 3e 00 00       	call   80104e79 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 d6 84 10 80 	movl   $0x801084d6,(%esp)
...
801012a3:	c7 04 24 df 84 10 80 	movl   $0x801084df,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 ef 84 10 80 	movl   $0x801084ef,(%esp)
...
80101320:	e8 14 3e 00 00       	call   80105139 <memmove>
  brelse(bp);
...
80101366:	e8 fb 3c 00 00       	call   80105066 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 f9 84 10 80 	movl   $0x801084f9,(%esp)
...
80101565:	c7 04 24 0f 85 10 80 	movl   $0x8010850f,(%esp)
...
801015b9:	c7 44 24 04 22 85 10 	movl   $0x80108522,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015c8:	e8 29 38 00 00       	call   80104df6 <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 17 3a 00 00       	call   80105066 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 29 85 10 80 	movl   $0x80108529,(%esp)
...
80101747:	e8 ed 39 00 00       	call   80105139 <memmove>
  log_write(bp);
...
80101771:	e8 a1 36 00 00       	call   80104e17 <acquire>
...
801017bb:	e8 b9 36 00 00       	call   80104e79 <release>
      return ip;
...
801017ee:	c7 04 24 3b 85 10 80 	movl   $0x8010853b,(%esp)
...
8010182c:	e8 48 36 00 00       	call   80104e79 <release>
...
80101843:	e8 cf 35 00 00       	call   80104e17 <acquire>
  ip->ref++;
...
8010185e:	e8 16 36 00 00       	call   80104e79 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 4b 85 10 80 	movl   $0x8010854b,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101891:	e8 81 35 00 00       	call   80104e17 <acquire>
...
801018a6:	e8 50 32 00 00       	call   80104afb <sleep>
...
801018d0:	e8 a4 35 00 00       	call   80104e79 <release>
...
8010197b:	e8 b9 37 00 00       	call   80105139 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 51 85 10 80 	movl   $0x80108551,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 60 85 10 80 	movl   $0x80108560,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019ec:	e8 26 34 00 00       	call   80104e17 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 da 31 00 00       	call   80104be7 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a14:	e8 60 34 00 00       	call   80104e79 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 ea 33 00 00       	call   80104e17 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 68 85 10 80 	movl   $0x80108568,(%esp)
...
80101a8a:	e8 ea 33 00 00       	call   80104e79 <release>
    itrunc(ip);
...
80101ab5:	e8 5d 33 00 00       	call   80104e17 <acquire>
    ip->flags = 0;
...
80101aca:	e8 18 31 00 00       	call   80104be7 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 8f 33 00 00       	call   80104e79 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 72 85 10 80 	movl   $0x80108572,(%esp)
...
80101e92:	e8 a2 32 00 00       	call   80105139 <memmove>
    brelse(bp);
...
80101ff8:	e8 3c 31 00 00       	call   80105139 <memmove>
    log_write(bp);
...
8010207a:	e8 5e 31 00 00       	call   801051dd <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 85 85 10 80 	movl   $0x80108585,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
...
801021fc:	e8 34 30 00 00       	call   80105235 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 a4 85 10 80 	movl   $0x801085a4,(%esp)
...
801022b5:	e8 7f 2e 00 00       	call   80105139 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 64 2e 00 00       	call   80105139 <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 ac 85 10 	movl   $0x801085ac,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
8010253b:	e8 b6 28 00 00       	call   80104df6 <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 b0 85 10 80 	movl   $0x801085b0,(%esp)
...
801026fe:	e8 14 27 00 00       	call   80104e17 <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 5c 27 00 00       	call   80104e79 <release>
...
8010278b:	e8 57 24 00 00       	call   80104be7 <wakeup>
...
801027ad:	e8 c7 26 00 00       	call   80104e79 <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 b9 85 10 80 	movl   $0x801085b9,(%esp)
...
801027df:	c7 04 24 cd 85 10 80 	movl   $0x801085cd,(%esp)
...
8010286a:	e8 8c 22 00 00       	call   80104afb <sleep>
...
80102886:	e8 ee 25 00 00       	call   80104e79 <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 00 86 10 80 	movl   $0x80108600,(%esp)
...
801029d7:	c7 44 24 04 32 86 10 	movl   $0x80108632,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029e6:	e8 0b 24 00 00       	call   80104df6 <initlock>
  kmem.use_lock = 0;
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 37 86 10 80 	movl   $0x80108637,(%esp)
...
80102ab5:	e8 ac 25 00 00       	call   80105066 <memset>
...
80102aca:	e8 48 23 00 00       	call   80104e17 <acquire>
  r = (struct run*)v;
...
80102af8:	e8 7c 23 00 00       	call   80104e79 <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 fd 22 00 00       	call   80104e17 <acquire>
  r = kmem.freelist;
...
80102b42:	e8 32 23 00 00       	call   80104e79 <release>
  return (char*)r;
...
80102ebe:	c7 04 24 40 86 10 80 	movl   $0x80108640,(%esp)
...
80103016:	c7 44 24 04 6c 86 10 	movl   $0x8010866c,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103025:	e8 cc 1d 00 00       	call   80104df6 <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 5c 20 00 00       	call   80105139 <memmove>
...
8010322a:	e8 e8 1b 00 00       	call   80104e17 <acquire>
  while (log.busy) {
...
80103240:	e8 b6 18 00 00       	call   80104afb <sleep>
...
8010325f:	e8 15 1c 00 00       	call   80104e79 <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
801032e0:	c7 04 24 70 86 10 80 	movl   $0x80108670,(%esp)
...
801032f5:	c7 04 24 86 86 10 80 	movl   $0x80108686,(%esp)
...
80103384:	e8 b0 1d 00 00       	call   80105139 <memmove>
  bwrite(lbuf);
...
80103424:	e8 a1 48 00 00       	call   80107cca <kvmalloc>
...
8010343b:	e8 2d 42 00 00       	call   8010766d <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 9d 86 10 80 	movl   $0x8010869d,(%esp)
...
8010346b:	e8 48 35 00 00       	call   801069b8 <uartinit>
  pinit();         // process table
80103470:	e8 4b 0d 00 00       	call   801041c0 <pinit>
  tvinit();        // trap vectors
80103475:	e8 bd 30 00 00       	call   80106537 <tvinit>
  binit();         // buffer cache
...
80103497:	e8 de 2f 00 00       	call   8010647a <timerinit>
...
801034b5:	e8 24 0e 00 00       	call   801042de <userinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 17 48 00 00       	call   80107ce1 <switchkvm>
  seginit();
801034ca:	e8 9e 41 00 00       	call   8010766d <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 b4 86 10 80 	movl   $0x801086b4,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 a3 31 00 00       	call   801066ab <idtinit>
...
80103523:	e8 24 13 00 00       	call   8010484c <scheduler>
...
80103555:	e8 df 1b 00 00       	call   80105139 <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 c8 86 10 	movl   $0x801086c8,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 e6 19 00 00       	call   801050dd <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 cd 86 10 	movl   $0x801086cd,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 a5 18 00 00       	call   801050dd <memcmp>
...
801038fe:	8b 04 85 10 87 10 80 	mov    -0x7fef78f0(,%eax,4),%eax
...
80103937:	c7 04 24 d2 86 10 80 	movl   $0x801086d2,(%esp)
...
801039ca:	c7 04 24 f0 86 10 80 	movl   $0x801086f0,(%esp)
...
80103ccf:	c7 44 24 04 24 87 10 	movl   $0x80108724,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 17 11 00 00       	call   80104df6 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 8b 10 00 00       	call   80104e17 <acquire>
  if(writable){
...
80103daa:	e8 38 0e 00 00       	call   80104be7 <wakeup>
...
80103dc9:	e8 19 0e 00 00       	call   80104be7 <wakeup>
  }
...
80103e06:	e8 6e 10 00 00       	call   80104e79 <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 f8 0f 00 00       	call   80104e17 <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 29 10 00 00       	call   80104e79 <release>
        return -1;
...
80103e65:	e8 7d 0d 00 00       	call   80104be7 <wakeup>
...
80103e7d:	e8 79 0c 00 00       	call   80104afb <sleep>
...
80103ee4:	e8 fe 0c 00 00       	call   80104be7 <wakeup>
  release(&p->lock);
80103ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eec:	89 04 24             	mov    %eax,(%esp)
80103eef:	e8 85 0f 00 00       	call   80104e79 <release>
  return n;
...
80103f0a:	e8 08 0f 00 00       	call   80104e17 <acquire>
...
80103f24:	e8 50 0f 00 00       	call   80104e79 <release>
      return -1;
...
80103f46:	e8 b0 0b 00 00       	call   80104afb <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fd6:	e8 0c 0c 00 00       	call   80104be7 <wakeup>
  release(&p->lock);
80103fdb:	8b 45 08             	mov    0x8(%ebp),%eax
80103fde:	89 04 24             	mov    %eax,(%esp)
80103fe1:	e8 93 0e 00 00       	call   80104e79 <release>
  return i;
...
801041c6:	c7 44 24 04 2c 87 10 	movl   $0x8010872c,0x4(%esp)
801041cd:	80 
801041ce:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801041d5:	e8 1c 0c 00 00       	call   80104df6 <initlock>
}
801041da:	c9                   	leave  
801041db:	c3                   	ret    
...
801041df:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *sp;

  acquire(&ptable.lock);
801041e2:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801041e9:	e8 29 0c 00 00       	call   80104e17 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ee:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801041f5:	eb 11                	jmp    80104208 <allocproc+0x2c>
    if(p->state == UNUSED)
801041f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041fa:	8b 40 0c             	mov    0xc(%eax),%eax
801041fd:	85 c0                	test   %eax,%eax
801041ff:	74 26                	je     80104227 <allocproc+0x4b>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104201:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104208:	81 7d f4 54 21 11 80 	cmpl   $0x80112154,-0xc(%ebp)
8010420f:	72 e6                	jb     801041f7 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104211:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104218:	e8 5c 0c 00 00       	call   80104e79 <release>
  return 0;
8010421d:	b8 00 00 00 00       	mov    $0x0,%eax
80104222:	e9 b5 00 00 00       	jmp    801042dc <allocproc+0x100>
  char *sp;
...
8010422b:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80104232:	a1 04 b0 10 80       	mov    0x8010b004,%eax
80104237:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010423a:	89 42 10             	mov    %eax,0x10(%edx)
8010423d:	83 c0 01             	add    $0x1,%eax
80104240:	a3 04 b0 10 80       	mov    %eax,0x8010b004
  release(&ptable.lock);
80104245:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010424c:	e8 28 0c 00 00       	call   80104e79 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104251:	e8 a9 e8 ff ff       	call   80102aff <kalloc>
80104256:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104259:	89 42 08             	mov    %eax,0x8(%edx)
8010425c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010425f:	8b 40 08             	mov    0x8(%eax),%eax
80104262:	85 c0                	test   %eax,%eax
80104264:	75 11                	jne    80104277 <allocproc+0x9b>
    p->state = UNUSED;
80104266:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104269:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104270:	b8 00 00 00 00       	mov    $0x0,%eax
80104275:	eb 65                	jmp    801042dc <allocproc+0x100>
  }
  sp = p->kstack + KSTACKSIZE;
80104277:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010427a:	8b 40 08             	mov    0x8(%eax),%eax
8010427d:	05 00 10 00 00       	add    $0x1000,%eax
80104282:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104285:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
80104289:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010428c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010428f:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104292:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
80104296:	ba ec 64 10 80       	mov    $0x801064ec,%edx
8010429b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010429e:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
801042a0:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
801042a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042a7:	8b 55 f0             	mov    -0x10(%ebp),%edx
801042aa:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
801042ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042b0:	8b 40 1c             	mov    0x1c(%eax),%eax
801042b3:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801042ba:	00 
801042bb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801042c2:	00 
801042c3:	89 04 24             	mov    %eax,(%esp)
801042c6:	e8 9b 0d 00 00       	call   80105066 <memset>
  p->context->eip = (uint)forkret;
801042cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042ce:	8b 40 1c             	mov    0x1c(%eax),%eax
801042d1:	ba cf 4a 10 80       	mov    $0x80104acf,%edx
801042d6:	89 50 10             	mov    %edx,0x10(%eax)
...
801042e1:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
801042e4:	e8 f3 fe ff ff       	call   801041dc <allocproc>
801042e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801042ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042ef:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm(kalloc)) == 0)
801042f4:	c7 04 24 ff 2a 10 80 	movl   $0x80102aff,(%esp)
801042fb:	e8 0d 39 00 00       	call   80107c0d <setupkvm>
80104300:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104303:	89 42 04             	mov    %eax,0x4(%edx)
80104306:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104309:	8b 40 04             	mov    0x4(%eax),%eax
8010430c:	85 c0                	test   %eax,%eax
8010430e:	75 0c                	jne    8010431c <userinit+0x3e>
    panic("userinit: out of memory?");
80104310:	c7 04 24 33 87 10 80 	movl   $0x80108733,(%esp)
80104317:	e8 21 c2 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010431c:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104321:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104324:	8b 40 04             	mov    0x4(%eax),%eax
80104327:	89 54 24 08          	mov    %edx,0x8(%esp)
8010432b:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
80104332:	80 
80104333:	89 04 24             	mov    %eax,(%esp)
80104336:	e8 2a 3b 00 00       	call   80107e65 <inituvm>
  p->sz = PGSIZE;
8010433b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010433e:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104344:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104347:	8b 40 18             	mov    0x18(%eax),%eax
8010434a:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104351:	00 
80104352:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104359:	00 
8010435a:	89 04 24             	mov    %eax,(%esp)
8010435d:	e8 04 0d 00 00       	call   80105066 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104362:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104365:	8b 40 18             	mov    0x18(%eax),%eax
80104368:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010436e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104371:	8b 40 18             	mov    0x18(%eax),%eax
80104374:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010437a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010437d:	8b 40 18             	mov    0x18(%eax),%eax
80104380:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104383:	8b 52 18             	mov    0x18(%edx),%edx
80104386:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010438a:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010438e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104391:	8b 40 18             	mov    0x18(%eax),%eax
80104394:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104397:	8b 52 18             	mov    0x18(%edx),%edx
8010439a:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010439e:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
801043a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043a5:	8b 40 18             	mov    0x18(%eax),%eax
801043a8:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801043af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043b2:	8b 40 18             	mov    0x18(%eax),%eax
801043b5:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801043bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043bf:	8b 40 18             	mov    0x18(%eax),%eax
801043c2:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
801043c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043cc:	83 c0 6c             	add    $0x6c,%eax
801043cf:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801043d6:	00 
801043d7:	c7 44 24 04 4c 87 10 	movl   $0x8010874c,0x4(%esp)
801043de:	80 
801043df:	89 04 24             	mov    %eax,(%esp)
801043e2:	e8 af 0e 00 00       	call   80105296 <safestrcpy>
  p->cwd = namei("/");
801043e7:	c7 04 24 55 87 10 80 	movl   $0x80108755,(%esp)
801043ee:	e8 17 e0 ff ff       	call   8010240a <namei>
801043f3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043f6:	89 42 68             	mov    %eax,0x68(%edx)

  make_runnable(p,0);
801043f9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104400:	00 
80104401:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104404:	89 04 24             	mov    %eax,(%esp)
80104407:	e8 73 fd ff ff       	call   8010417f <make_runnable>
  //p->state = RUNNABLE;
}
8010440c:	c9                   	leave  
8010440d:	c3                   	ret    
...
80104411:	83 ec 28             	sub    $0x28,%esp
  uint sz;
  
  sz = proc->sz;
80104414:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010441a:	8b 00                	mov    (%eax),%eax
8010441c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
8010441f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104423:	7e 34                	jle    80104459 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104425:	8b 45 08             	mov    0x8(%ebp),%eax
80104428:	89 c2                	mov    %eax,%edx
8010442a:	03 55 f4             	add    -0xc(%ebp),%edx
...
80104444:	e8 96 3b 00 00       	call   80107fdf <allocuvm>
80104449:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010444c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104450:	75 41                	jne    80104493 <growproc+0x85>
      return -1;
80104452:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104457:	eb 58                	jmp    801044b1 <growproc+0xa3>
  } else if(n < 0){
80104459:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010445d:	79 34                	jns    80104493 <growproc+0x85>
...
8010447e:	e8 36 3c 00 00       	call   801080b9 <deallocuvm>
80104483:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104486:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010448a:	75 07                	jne    80104493 <growproc+0x85>
      return -1;
8010448c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104491:	eb 1e                	jmp    801044b1 <growproc+0xa3>
  }
  proc->sz = sz;
...
801044a7:	e8 52 38 00 00       	call   80107cfe <switchuvm>
  return 0;
...
801044b9:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
801044bc:	e8 1b fd ff ff       	call   801041dc <allocproc>
801044c1:	89 45 e0             	mov    %eax,-0x20(%ebp)
801044c4:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801044c8:	75 0a                	jne    801044d4 <fork+0x21>
    return -1;
801044ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044cf:	e9 43 01 00 00       	jmp    80104617 <fork+0x164>
...
801044e5:	89 54 24 04          	mov    %edx,0x4(%esp)
801044e9:	89 04 24             	mov    %eax,(%esp)
801044ec:	e8 58 3d 00 00       	call   80108249 <copyuvm>
801044f1:	8b 55 e0             	mov    -0x20(%ebp),%edx
...
80104558:	b8 13 00 00 00       	mov    $0x13,%eax
8010455d:	89 d7                	mov    %edx,%edi
8010455f:	89 de                	mov    %ebx,%esi
80104561:	89 c1                	mov    %eax,%ecx
80104563:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80104565:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104568:	8b 40 18             	mov    0x18(%eax),%eax
8010456b:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104572:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104579:	eb 3d                	jmp    801045b8 <fork+0x105>
    if(proc->ofile[i])
8010457b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104581:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104584:	83 c2 08             	add    $0x8,%edx
80104587:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010458b:	85 c0                	test   %eax,%eax
8010458d:	74 25                	je     801045b4 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
8010458f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104595:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104598:	83 c2 08             	add    $0x8,%edx
8010459b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010459f:	89 04 24             	mov    %eax,(%esp)
801045a2:	e8 d5 c9 ff ff       	call   80100f7c <filedup>
801045a7:	8b 55 e0             	mov    -0x20(%ebp),%edx
801045aa:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801045ad:	83 c1 08             	add    $0x8,%ecx
801045b0:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801045b4:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801045b8:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801045bc:	7e bd                	jle    8010457b <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
801045ca:	e8 67 d2 ff ff       	call   80101836 <idup>
801045cf:	8b 55 e0             	mov    -0x20(%ebp),%edx
801045d2:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
801045d5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045d8:	8b 40 10             	mov    0x10(%eax),%eax
801045db:	89 45 dc             	mov    %eax,-0x24(%ebp)
  make_runnable(np,0);
801045de:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801045e5:	00 
801045e6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045e9:	89 04 24             	mov    %eax,(%esp)
801045ec:	e8 8e fb ff ff       	call   8010417f <make_runnable>
  //np->state = RUNNABLE;
...
8010460f:	e8 82 0c 00 00       	call   80105296 <safestrcpy>
  return pid;
...
80104622:	83 ec 28             	sub    $0x28,%esp
  ...
  if(proc == initproc)
80104625:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010462c:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104631:	39 c2                	cmp    %eax,%edx
80104633:	75 0c                	jne    80104641 <exit+0x22>
    panic("init exiting");
80104635:	c7 04 24 57 87 10 80 	movl   $0x80108757,(%esp)
8010463c:	e8 fc be ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104641:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104648:	eb 44                	jmp    8010468e <exit+0x6f>
    if(proc->ofile[fd]){
8010464a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104650:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104653:	83 c2 08             	add    $0x8,%edx
80104656:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010465a:	85 c0                	test   %eax,%eax
8010465c:	74 2c                	je     8010468a <exit+0x6b>
...
80104671:	e8 4e c9 ff ff       	call   80100fc4 <fileclose>
      proc->ofile[fd] = 0;
80104676:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010467c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010467f:	83 c2 08             	add    $0x8,%edx
80104682:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104689:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010468a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
8010468e:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104692:	7e b6                	jle    8010464a <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
801046a0:	e8 76 d3 ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
801046a5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046ab:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801046b2:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801046b9:	e8 59 07 00 00       	call   80104e17 <acquire>
...
801046ca:	e8 c7 04 00 00       	call   80104b96 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046cf:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801046d6:	eb 3b                	jmp    80104713 <exit+0xf4>
    if(p->parent == proc){
801046d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046db:	8b 50 14             	mov    0x14(%eax),%edx
801046de:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046e4:	39 c2                	cmp    %eax,%edx
801046e6:	75 24                	jne    8010470c <exit+0xed>
      p->parent = initproc;
801046e8:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
...
801046fd:	75 0d                	jne    8010470c <exit+0xed>
        wakeup1(initproc);
801046ff:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104704:	89 04 24             	mov    %eax,(%esp)
80104707:	e8 8a 04 00 00       	call   80104b96 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010470c:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104713:	81 7d f4 54 21 11 80 	cmpl   $0x80112154,-0xc(%ebp)
8010471a:	72 bc                	jb     801046d8 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
80104722:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104729:	e8 a9 02 00 00       	call   801049d7 <sched>
  panic("zombie exit");
8010472e:	c7 04 24 64 87 10 80 	movl   $0x80108764,(%esp)
80104735:	e8 03 be ff ff       	call   8010053d <panic>
...
8010473d:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80104740:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104747:	e8 cb 06 00 00       	call   80104e17 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010474c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104753:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
8010475a:	e9 9d 00 00 00       	jmp    801047fc <wait+0xc2>
      if(p->parent != proc)
8010475f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104762:	8b 50 14             	mov    0x14(%eax),%edx
80104765:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010476b:	39 c2                	cmp    %eax,%edx
8010476d:	0f 85 81 00 00 00    	jne    801047f4 <wait+0xba>
        continue;
      havekids = 1;
80104773:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
8010477a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010477d:	8b 40 0c             	mov    0xc(%eax),%eax
80104780:	83 f8 05             	cmp    $0x5,%eax
80104783:	75 70                	jne    801047f5 <wait+0xbb>
        // Found one.
        pid = p->pid;
...
80104791:	8b 40 08             	mov    0x8(%eax),%eax
80104794:	89 04 24             	mov    %eax,(%esp)
80104797:	e8 ca e2 ff ff       	call   80102a66 <kfree>
        p->kstack = 0;
...
801047af:	e8 c1 39 00 00       	call   80108175 <freevm>
        p->state = UNUSED;
801047b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047b7:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801047be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047c1:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801047c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047cb:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801047d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047d5:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
801047d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047dc:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801047e3:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801047ea:	e8 8a 06 00 00       	call   80104e79 <release>
        return pid;
801047ef:	8b 45 ec             	mov    -0x14(%ebp),%eax
801047f2:	eb 56                	jmp    8010484a <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801047f4:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047f5:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
801047fc:	81 7d f4 54 21 11 80 	cmpl   $0x80112154,-0xc(%ebp)
80104803:	0f 82 56 ff ff ff    	jb     8010475f <wait+0x25>
        return pid;
      }
    }
...
80104809:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010480d:	74 0d                	je     8010481c <wait+0xe2>
8010480f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104815:	8b 40 24             	mov    0x24(%eax),%eax
80104818:	85 c0                	test   %eax,%eax
8010481a:	74 13                	je     8010482f <wait+0xf5>
      release(&ptable.lock);
8010481c:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104823:	e8 51 06 00 00       	call   80104e79 <release>
      return -1;
80104828:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010482d:	eb 1b                	jmp    8010484a <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010482f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104835:	c7 44 24 04 20 ff 10 	movl   $0x8010ff20,0x4(%esp)
8010483c:	80 
8010483d:	89 04 24             	mov    %eax,(%esp)
80104840:	e8 b6 02 00 00       	call   80104afb <sleep>
  }
80104845:	e9 02 ff ff ff       	jmp    8010474c <wait+0x12>
}
8010484a:	c9                   	leave  
8010484b:	c3                   	ret    
...
80104852:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
      ...
      sti();
80104859:	e8 a7 f7 ff ff       	call   80104005 <sti>
     // Loop over process table looking for process to run.
      acquire(&ptable.lock);
8010485e:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104865:	e8 ad 05 00 00       	call   80104e17 <acquire>
      while(indice < MLF_LEVELS)    //  Con esto recorro los niveles de MLF
8010486a:	e9 4d 01 00 00       	jmp    801049bc <scheduler+0x170>
      {

      if(ptable.mlf[indice].first != 0)
8010486f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104872:	05 46 04 00 00       	add    $0x446,%eax
80104877:	8b 04 c5 24 ff 10 80 	mov    -0x7fef00dc(,%eax,8),%eax
8010487e:	85 c0                	test   %eax,%eax
80104880:	0f 84 1f 01 00 00    	je     801049a5 <scheduler+0x159>
	   {
			  p = ptable.mlf[indice].first;	
80104886:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104889:	05 46 04 00 00       	add    $0x446,%eax
8010488e:	8b 04 c5 24 ff 10 80 	mov    -0x7fef00dc(,%eax,8),%eax
80104895:	89 45 f0             	mov    %eax,-0x10(%ebp)
              cprintf("edi  %d  \n",p->context->edi);
80104898:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010489b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010489e:	8b 00                	mov    (%eax),%eax
801048a0:	89 44 24 04          	mov    %eax,0x4(%esp)
801048a4:	c7 04 24 70 87 10 80 	movl   $0x80108770,(%esp)
801048ab:	e8 f1 ba ff ff       	call   801003a1 <cprintf>
              cprintf("esi  %d  \n",p->context->esi);
801048b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801048b3:	8b 40 1c             	mov    0x1c(%eax),%eax
801048b6:	8b 40 04             	mov    0x4(%eax),%eax
801048b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801048bd:	c7 04 24 7b 87 10 80 	movl   $0x8010877b,(%esp)
801048c4:	e8 d8 ba ff ff       	call   801003a1 <cprintf>
              cprintf("ebx  %d  \n",p->context->ebx);
801048c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801048cc:	8b 40 1c             	mov    0x1c(%eax),%eax
801048cf:	8b 40 08             	mov    0x8(%eax),%eax
801048d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801048d6:	c7 04 24 86 87 10 80 	movl   $0x80108786,(%esp)
801048dd:	e8 bf ba ff ff       	call   801003a1 <cprintf>
              cprintf("ebp  %d  \n",p->context->ebp);
801048e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801048e5:	8b 40 1c             	mov    0x1c(%eax),%eax
801048e8:	8b 40 0c             	mov    0xc(%eax),%eax
801048eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801048ef:	c7 04 24 91 87 10 80 	movl   $0x80108791,(%esp)
801048f6:	e8 a6 ba ff ff       	call   801003a1 <cprintf>
              cprintf("eip  %d  \n",p->context->eip);
801048fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801048fe:	8b 40 1c             	mov    0x1c(%eax),%eax
80104901:	8b 40 10             	mov    0x10(%eax),%eax
80104904:	89 44 24 04          	mov    %eax,0x4(%esp)
80104908:	c7 04 24 9c 87 10 80 	movl   $0x8010879c,(%esp)
8010490f:	e8 8d ba ff ff       	call   801003a1 <cprintf>
              cprintf("kstack  %s  \n",p->kstack);
80104914:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104917:	8b 40 08             	mov    0x8(%eax),%eax
8010491a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010491e:	c7 04 24 a7 87 10 80 	movl   $0x801087a7,(%esp)
80104925:	e8 77 ba ff ff       	call   801003a1 <cprintf>
              cprintf("   \n");
8010492a:	c7 04 24 b5 87 10 80 	movl   $0x801087b5,(%esp)
80104931:	e8 6b ba ff ff       	call   801003a1 <cprintf>
              

                            
                            
			  if(p->state != RUNNABLE)
80104936:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104939:	8b 40 0c             	mov    0xc(%eax),%eax
8010493c:	83 f8 03             	cmp    $0x3,%eax
8010493f:	74 0c                	je     8010494d <scheduler+0x101>
				panic("This proces is not RUNNABLE");
80104941:	c7 04 24 ba 87 10 80 	movl   $0x801087ba,(%esp)
80104948:	e8 f0 bb ff ff       	call   8010053d <panic>
			   // Switch to chosen process.  It is the process's job
			  // to release ptable.lock and then reacquire it
			  // before jumping back to us.
			  proc = p;
8010494d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104950:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
			  switchuvm(p);
80104956:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104959:	89 04 24             	mov    %eax,(%esp)
8010495c:	e8 9d 33 00 00       	call   80107cfe <switchuvm>
...
80104967:	e8 37 f8 ff ff       	call   801041a3 <make_running>
			  p->quantum = 0;
8010496c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010496f:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
			  swtch(&cpu->scheduler, proc->context);
80104976:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010497c:	8b 40 1c             	mov    0x1c(%eax),%eax
8010497f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104986:	83 c2 04             	add    $0x4,%edx
80104989:	89 44 24 04          	mov    %eax,0x4(%esp)
8010498d:	89 14 24             	mov    %edx,(%esp)
80104990:	e8 77 09 00 00       	call   8010530c <swtch>
			  switchkvm();
80104995:	e8 47 33 00 00       	call   80107ce1 <switchkvm>
			  // Process is done running for now.
			  // It should have changed its p->state before coming back.
	 	     proc = 0;
8010499a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801049a1:	00 00 00 00 
		}
...
801049a8:	05 46 04 00 00       	add    $0x446,%eax
801049ad:	8b 04 c5 24 ff 10 80 	mov    -0x7fef00dc(,%eax,8),%eax
801049b4:	85 c0                	test   %eax,%eax
801049b6:	75 04                	jne    801049bc <scheduler+0x170>
        	indice++;
801049b8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
	  indice = 0;  
      // Enable interrupts on this processor.
      sti();
     // Loop over process table looking for process to run.
      acquire(&ptable.lock);
      while(indice < MLF_LEVELS)    //  Con esto recorro los niveles de MLF
801049bc:	83 7d f4 03          	cmpl   $0x3,-0xc(%ebp)
801049c0:	0f 8e a9 fe ff ff    	jle    8010486f <scheduler+0x23>
	 	     proc = 0;
		}
        if(ptable.mlf[indice].first == 0	)  // Me aseguro que recorro todos los proceso de un nivel antes de avanzar 
        	indice++;
...
801049cd:	e8 a7 04 00 00       	call   80104e79 <release>
  }
801049d2:	e9 7b fe ff ff       	jmp    80104852 <scheduler+0x6>
...
801049da:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
801049dd:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801049e4:	e8 4c 05 00 00       	call   80104f35 <holding>
801049e9:	85 c0                	test   %eax,%eax
801049eb:	75 0c                	jne    801049f9 <sched+0x22>
    panic("sched ptable.lock");
801049ed:	c7 04 24 d6 87 10 80 	movl   $0x801087d6,(%esp)
801049f4:	e8 44 bb ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
801049f9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049ff:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104a05:	83 f8 01             	cmp    $0x1,%eax
80104a08:	74 0c                	je     80104a16 <sched+0x3f>
    panic("sched locks");
80104a0a:	c7 04 24 e8 87 10 80 	movl   $0x801087e8,(%esp)
80104a11:	e8 27 bb ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104a16:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a1c:	8b 40 0c             	mov    0xc(%eax),%eax
80104a1f:	83 f8 04             	cmp    $0x4,%eax
80104a22:	75 0c                	jne    80104a30 <sched+0x59>
    panic("sched running");
80104a24:	c7 04 24 f4 87 10 80 	movl   $0x801087f4,(%esp)
80104a2b:	e8 0d bb ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104a30:	e8 bb f5 ff ff       	call   80103ff0 <readeflags>
80104a35:	25 00 02 00 00       	and    $0x200,%eax
80104a3a:	85 c0                	test   %eax,%eax
80104a3c:	74 0c                	je     80104a4a <sched+0x73>
    panic("sched interruptible");
80104a3e:	c7 04 24 02 88 10 80 	movl   $0x80108802,(%esp)
80104a45:	e8 f3 ba ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104a4a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a50:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104a56:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104a59:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a5f:	8b 40 04             	mov    0x4(%eax),%eax
80104a62:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104a69:	83 c2 1c             	add    $0x1c,%edx
80104a6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a70:	89 14 24             	mov    %edx,(%esp)
80104a73:	e8 94 08 00 00       	call   8010530c <swtch>
  cpu->intena = intena;
80104a78:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a7e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a81:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104a87:	c9                   	leave  
80104a88:	c3                   	ret    
...
80104a8f:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104a96:	e8 7c 03 00 00       	call   80104e17 <acquire>
...
80104aa4:	e8 94 f5 ff ff       	call   8010403d <down>
80104aa9:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104ab0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ab4:	89 14 24             	mov    %edx,(%esp)
80104ab7:	e8 c3 f6 ff ff       	call   8010417f <make_runnable>
  //proc->state = RUNNABLE;
  sched();
80104abc:	e8 16 ff ff ff       	call   801049d7 <sched>
  release(&ptable.lock);
80104ac1:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104ac8:	e8 ac 03 00 00       	call   80104e79 <release>
}
80104acd:	c9                   	leave  
80104ace:	c3                   	ret    
...
80104ad2:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104ad5:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104adc:	e8 98 03 00 00       	call   80104e79 <release>

  if (first) {
80104ae1:	a1 20 b0 10 80       	mov    0x8010b020,%eax
80104ae6:	85 c0                	test   %eax,%eax
80104ae8:	74 0f                	je     80104af9 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104aea:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
80104af1:	00 00 00 
    initlog();
80104af4:	e8 17 e5 ff ff       	call   80103010 <initlog>
  }
...
80104b09:	75 0c                	jne    80104b17 <sleep+0x1c>
    panic("sleep");
80104b0b:	c7 04 24 16 88 10 80 	movl   $0x80108816,(%esp)
80104b12:	e8 26 ba ff ff       	call   8010053d <panic>

  if(lk == 0)
80104b17:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104b1b:	75 0c                	jne    80104b29 <sleep+0x2e>
    panic("sleep without lk");
80104b1d:	c7 04 24 1c 88 10 80 	movl   $0x8010881c,(%esp)
80104b24:	e8 14 ba ff ff       	call   8010053d <panic>
...
80104b29:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
80104b30:	74 17                	je     80104b49 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104b32:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104b39:	e8 d9 02 00 00       	call   80104e17 <acquire>
    release(lk);
80104b3e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b41:	89 04 24             	mov    %eax,(%esp)
80104b44:	e8 30 03 00 00       	call   80104e79 <release>
  }

  // Go to sleep.
  proc->chan = chan;
80104b49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b4f:	8b 55 08             	mov    0x8(%ebp),%edx
80104b52:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104b55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b5b:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104b62:	e8 70 fe ff ff       	call   801049d7 <sched>

  // Tidy up.
  proc->chan = 0;
80104b67:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b6d:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104b74:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
80104b7b:	74 17                	je     80104b94 <sleep+0x99>
    release(&ptable.lock);
80104b7d:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104b84:	e8 f0 02 00 00       	call   80104e79 <release>
    acquire(lk);
80104b89:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b8c:	89 04 24             	mov    %eax,(%esp)
80104b8f:	e8 83 02 00 00       	call   80104e17 <acquire>
  }
}
80104b94:	c9                   	leave  
80104b95:	c3                   	ret    
...
80104b99:	83 ec 18             	sub    $0x18,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b9c:	c7 45 fc 54 ff 10 80 	movl   $0x8010ff54,-0x4(%ebp)
80104ba3:	eb 37                	jmp    80104bdc <wakeup1+0x46>
    if(p->state == SLEEPING && p->chan == chan)
80104ba5:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ba8:	8b 40 0c             	mov    0xc(%eax),%eax
80104bab:	83 f8 02             	cmp    $0x2,%eax
80104bae:	75 25                	jne    80104bd5 <wakeup1+0x3f>
80104bb0:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104bb3:	8b 40 20             	mov    0x20(%eax),%eax
80104bb6:	3b 45 08             	cmp    0x8(%ebp),%eax
80104bb9:	75 1a                	jne    80104bd5 <wakeup1+0x3f>
    {
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104bd5:	81 45 fc 88 00 00 00 	addl   $0x88,-0x4(%ebp)
80104bdc:	81 7d fc 54 21 11 80 	cmpl   $0x80112154,-0x4(%ebp)
80104be3:	72 c0                	jb     80104ba5 <wakeup1+0xf>
    {
//      cprintf("El proceso %s pasa a RUNNABLE por WAKEUP \n",p->name);
      make_runnable(p,up(p));//Sube de nivel
    }
...
80104bea:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104bed:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104bf4:	e8 1e 02 00 00       	call   80104e17 <acquire>
  wakeup1(chan);
80104bf9:	8b 45 08             	mov    0x8(%ebp),%eax
80104bfc:	89 04 24             	mov    %eax,(%esp)
80104bff:	e8 92 ff ff ff       	call   80104b96 <wakeup1>
  release(&ptable.lock);
80104c04:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104c0b:	e8 69 02 00 00       	call   80104e79 <release>
}
80104c10:	c9                   	leave  
80104c11:	c3                   	ret    
...
80104c15:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104c18:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104c1f:	e8 f3 01 00 00       	call   80104e17 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c24:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104c2b:	eb 68                	jmp    80104c95 <kill+0x83>
    if(p->pid == pid){
80104c2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c30:	8b 40 10             	mov    0x10(%eax),%eax
80104c33:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c36:	75 56                	jne    80104c8e <kill+0x7c>
      p->killed = 1;
80104c38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c3b:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104c42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c45:	8b 40 0c             	mov    0xc(%eax),%eax
80104c48:	83 f8 02             	cmp    $0x2,%eax
80104c4b:	75 2e                	jne    80104c7b <kill+0x69>
      {
        cprintf("El proceso %s pasa a RUNNABLE por KILL \n",p->name);
80104c4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c50:	83 c0 6c             	add    $0x6c,%eax
80104c53:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c57:	c7 04 24 30 88 10 80 	movl   $0x80108830,(%esp)
80104c5e:	e8 3e b7 ff ff       	call   801003a1 <cprintf>
        make_runnable(p,p->current_level);//Queda el nivel q estaba
80104c63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c66:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104c6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c73:	89 04 24             	mov    %eax,(%esp)
80104c76:	e8 04 f5 ff ff       	call   8010417f <make_runnable>
        //p->state = RUNNABLE;
      }
      release(&ptable.lock);
80104c7b:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104c82:	e8 f2 01 00 00       	call   80104e79 <release>
      return 0;
80104c87:	b8 00 00 00 00       	mov    $0x0,%eax
80104c8c:	eb 21                	jmp    80104caf <kill+0x9d>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c8e:	81 45 f4 88 00 00 00 	addl   $0x88,-0xc(%ebp)
80104c95:	81 7d f4 54 21 11 80 	cmpl   $0x80112154,-0xc(%ebp)
80104c9c:	72 8f                	jb     80104c2d <kill+0x1b>
      }
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104c9e:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104ca5:	e8 cf 01 00 00       	call   80104e79 <release>
  return -1;
...
80104cb4:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cb7:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
80104cbe:	e9 db 00 00 00       	jmp    80104d9e <procdump+0xed>
    if(p->state == UNUSED)
80104cc3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cc6:	8b 40 0c             	mov    0xc(%eax),%eax
80104cc9:	85 c0                	test   %eax,%eax
80104ccb:	0f 84 c5 00 00 00    	je     80104d96 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104cd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cd4:	8b 40 0c             	mov    0xc(%eax),%eax
80104cd7:	83 f8 05             	cmp    $0x5,%eax
80104cda:	77 23                	ja     80104cff <procdump+0x4e>
80104cdc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cdf:	8b 40 0c             	mov    0xc(%eax),%eax
80104ce2:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104ce9:	85 c0                	test   %eax,%eax
80104ceb:	74 12                	je     80104cff <procdump+0x4e>
      state = states[p->state];
80104ced:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cf0:	8b 40 0c             	mov    0xc(%eax),%eax
80104cf3:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104cfa:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104cfd:	eb 07                	jmp    80104d06 <procdump+0x55>
    else
      state = "???";
80104cff:	c7 45 ec 59 88 10 80 	movl   $0x80108859,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104d06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d09:	8d 50 6c             	lea    0x6c(%eax),%edx
80104d0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d0f:	8b 40 10             	mov    0x10(%eax),%eax
80104d12:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104d16:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104d19:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d1d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d21:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
80104d28:	e8 74 b6 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104d2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d30:	8b 40 0c             	mov    0xc(%eax),%eax
80104d33:	83 f8 02             	cmp    $0x2,%eax
80104d36:	75 50                	jne    80104d88 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104d38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d3b:	8b 40 1c             	mov    0x1c(%eax),%eax
80104d3e:	8b 40 0c             	mov    0xc(%eax),%eax
80104d41:	83 c0 08             	add    $0x8,%eax
80104d44:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104d47:	89 54 24 04          	mov    %edx,0x4(%esp)
80104d4b:	89 04 24             	mov    %eax,(%esp)
80104d4e:	e8 75 01 00 00       	call   80104ec8 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104d53:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104d5a:	eb 1b                	jmp    80104d77 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104d5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d5f:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d63:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d67:	c7 04 24 66 88 10 80 	movl   $0x80108866,(%esp)
80104d6e:	e8 2e b6 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104d73:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104d77:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104d7b:	7f 0b                	jg     80104d88 <procdump+0xd7>
80104d7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d80:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d84:	85 c0                	test   %eax,%eax
80104d86:	75 d4                	jne    80104d5c <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104d88:	c7 04 24 6a 88 10 80 	movl   $0x8010886a,(%esp)
80104d8f:	e8 0d b6 ff ff       	call   801003a1 <cprintf>
80104d94:	eb 01                	jmp    80104d97 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104d96:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d97:	81 45 f0 88 00 00 00 	addl   $0x88,-0x10(%ebp)
80104d9e:	81 7d f0 54 21 11 80 	cmpl   $0x80112154,-0x10(%ebp)
80104da5:	0f 82 18 ff ff ff    	jb     80104cc3 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104e2f:	74 0c                	je     80104e3d <acquire+0x26>
    panic("acquire");
80104e31:	c7 04 24 96 88 10 80 	movl   $0x80108896,(%esp)
...
80104e8c:	75 0c                	jne    80104e9a <release+0x21>
    panic("release");
80104e8e:	c7 04 24 9e 88 10 80 	movl   $0x8010889e,(%esp)
...
80104fbb:	c7 04 24 a6 88 10 80 	movl   $0x801088a6,(%esp)
...
80104fe4:	79 0c                	jns    80104ff2 <popcli+0x4b>
    panic("popcli");
80104fe6:	c7 04 24 bd 88 10 80 	movl   $0x801088bd,(%esp)
...
801054a3:	78 2e                	js     801054d3 <syscall+0x4a>
801054a5:	83 7d f4 10          	cmpl   $0x10,-0xc(%ebp)
801054a9:	7f 28                	jg     801054d3 <syscall+0x4a>
801054ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054ae:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054b5:	85 c0                	test   %eax,%eax
801054b7:	74 1a                	je     801054d3 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
801054b9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054bf:	8b 58 18             	mov    0x18(%eax),%ebx
801054c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054c5:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054cc:	ff d0                	call   *%eax
801054ce:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054d1:	eb 73                	jmp    80105546 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
801054d3:	83 7d f4 10          	cmpl   $0x10,-0xc(%ebp)
801054d7:	7e 30                	jle    80105509 <syscall+0x80>
801054d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054dc:	83 f8 17             	cmp    $0x17,%eax
801054df:	77 28                	ja     80105509 <syscall+0x80>
801054e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e4:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054eb:	85 c0                	test   %eax,%eax
801054ed:	74 1a                	je     80105509 <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801054ef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054f5:	8b 58 18             	mov    0x18(%eax),%ebx
801054f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054fb:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105502:	ff d0                	call   *%eax
80105504:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105507:	eb 3d                	jmp    80105546 <syscall+0xbd>
  } else {
...
80105512:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105518:	8b 40 10             	mov    0x10(%eax),%eax
8010551b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010551e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105522:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105526:	89 44 24 04          	mov    %eax,0x4(%esp)
8010552a:	c7 04 24 c4 88 10 80 	movl   $0x801088c4,(%esp)
80105531:	e8 6b ae ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105536:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010553c:	8b 40 18             	mov    0x18(%eax),%eax
8010553f:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
8010555f:	e8 5e fe ff ff       	call   801053c2 <argint>
80105564:	85 c0                	test   %eax,%eax
80105566:	79 07                	jns    8010556f <argfd+0x23>
    return -1;
80105568:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010556d:	eb 50                	jmp    801055bf <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
8010556f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105572:	85 c0                	test   %eax,%eax
80105574:	78 21                	js     80105597 <argfd+0x4b>
80105576:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105579:	83 f8 0f             	cmp    $0xf,%eax
8010557c:	7f 19                	jg     80105597 <argfd+0x4b>
8010557e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105584:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105587:	83 c2 08             	add    $0x8,%edx
8010558a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010558e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105591:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105595:	75 07                	jne    8010559e <argfd+0x52>
    return -1;
80105597:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010559c:	eb 21                	jmp    801055bf <argfd+0x73>
  if(pfd)
8010559e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801055a2:	74 08                	je     801055ac <argfd+0x60>
    *pfd = fd;
801055a4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055a7:	8b 45 0c             	mov    0xc(%ebp),%eax
801055aa:	89 10                	mov    %edx,(%eax)
  if(pf)
801055ac:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801055b0:	74 08                	je     801055ba <argfd+0x6e>
    *pf = f;
801055b2:	8b 45 10             	mov    0x10(%ebp),%eax
801055b5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055b8:	89 10                	mov    %edx,(%eax)
  return 0;
...
801055c4:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801055c7:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801055ce:	eb 30                	jmp    80105600 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801055d0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055d6:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055d9:	83 c2 08             	add    $0x8,%edx
801055dc:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801055e0:	85 c0                	test   %eax,%eax
801055e2:	75 18                	jne    801055fc <fdalloc+0x3b>
      proc->ofile[fd] = f;
801055e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055ea:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055ed:	8d 4a 08             	lea    0x8(%edx),%ecx
801055f0:	8b 55 08             	mov    0x8(%ebp),%edx
801055f3:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801055f7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055fa:	eb 0f                	jmp    8010560b <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105600:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105604:	7e ca                	jle    801055d0 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105610:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
80105680:	e8 c7 fe ff ff       	call   8010554c <argfd>
80105685:	85 c0                	test   %eax,%eax
80105687:	78 35                	js     801056be <sys_read+0x5a>
80105689:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010568c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105690:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105697:	e8 26 fd ff ff       	call   801053c2 <argint>
8010569c:	85 c0                	test   %eax,%eax
8010569e:	78 1e                	js     801056be <sys_read+0x5a>
...
801056b5:	e8 36 fd ff ff       	call   801053f0 <argptr>
801056ba:	85 c0                	test   %eax,%eax
801056bc:	79 07                	jns    801056c5 <sys_read+0x61>
    return -1;
801056be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056c3:	eb 19                	jmp    801056de <sys_read+0x7a>
...
801056d9:	e8 0b ba ff ff       	call   801010e9 <fileread>
}
801056de:	c9                   	leave  
801056df:	c3                   	ret    
...
801056fc:	e8 4b fe ff ff       	call   8010554c <argfd>
80105701:	85 c0                	test   %eax,%eax
80105703:	78 35                	js     8010573a <sys_write+0x5a>
80105705:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105708:	89 44 24 04          	mov    %eax,0x4(%esp)
8010570c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105713:	e8 aa fc ff ff       	call   801053c2 <argint>
80105718:	85 c0                	test   %eax,%eax
8010571a:	78 1e                	js     8010573a <sys_write+0x5a>
8010571c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010571f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105723:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105726:	89 44 24 04          	mov    %eax,0x4(%esp)
8010572a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105731:	e8 ba fc ff ff       	call   801053f0 <argptr>
80105736:	85 c0                	test   %eax,%eax
80105738:	79 07                	jns    80105741 <sys_write+0x61>
    return -1;
8010573a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010573f:	eb 19                	jmp    8010575a <sys_write+0x7a>
  return filewrite(f, p, n);
80105741:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105744:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105747:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010574a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010574e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105752:	89 04 24             	mov    %eax,(%esp)
80105755:	e8 4b ba ff ff       	call   801011a5 <filewrite>
}
8010575a:	c9                   	leave  
8010575b:	c3                   	ret    
...
8010575f:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105770:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105777:	e8 d0 fd ff ff       	call   8010554c <argfd>
8010577c:	85 c0                	test   %eax,%eax
8010577e:	79 07                	jns    80105787 <sys_close+0x2b>
    return -1;
80105780:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105785:	eb 24                	jmp    801057ab <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105787:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010578d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105790:	83 c2 08             	add    $0x8,%edx
80105793:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010579a:	00 
  fileclose(f);
8010579b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010579e:	89 04 24             	mov    %eax,(%esp)
801057a1:	e8 1e b8 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
801057b3:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057b6:	89 44 24 08          	mov    %eax,0x8(%esp)
801057ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801057c1:	00 
801057c2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057c9:	e8 7e fd ff ff       	call   8010554c <argfd>
801057ce:	85 c0                	test   %eax,%eax
801057d0:	78 1f                	js     801057f1 <sys_fstat+0x44>
801057d2:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801057d9:	00 
801057da:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057e8:	e8 03 fc ff ff       	call   801053f0 <argptr>
801057ed:	85 c0                	test   %eax,%eax
801057ef:	79 07                	jns    801057f8 <sys_fstat+0x4b>
    return -1;
801057f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057f6:	eb 12                	jmp    8010580a <sys_fstat+0x5d>
  return filestat(f, st);
801057f8:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057fe:	89 54 24 04          	mov    %edx,0x4(%esp)
80105802:	89 04 24             	mov    %eax,(%esp)
80105805:	e8 90 b8 ff ff       	call   8010109a <filestat>
}
8010580a:	c9                   	leave  
8010580b:	c3                   	ret    
...
8010580f:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105812:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105815:	89 44 24 04          	mov    %eax,0x4(%esp)
80105819:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105820:	e8 2d fc ff ff       	call   80105452 <argstr>
80105825:	85 c0                	test   %eax,%eax
80105827:	78 17                	js     80105840 <sys_link+0x34>
80105829:	8d 45 dc             	lea    -0x24(%ebp),%eax
8010582c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105830:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105837:	e8 16 fc ff ff       	call   80105452 <argstr>
8010583c:	85 c0                	test   %eax,%eax
8010583e:	79 0a                	jns    8010584a <sys_link+0x3e>
    return -1;
80105840:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105845:	e9 3c 01 00 00       	jmp    80105986 <sys_link+0x17a>
  if((ip = namei(old)) == 0)
8010584a:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010584d:	89 04 24             	mov    %eax,(%esp)
80105850:	e8 b5 cb ff ff       	call   8010240a <namei>
80105855:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105858:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010585c:	75 0a                	jne    80105868 <sys_link+0x5c>
    return -1;
8010585e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105863:	e9 1e 01 00 00       	jmp    80105986 <sys_link+0x17a>

  begin_trans();
80105868:	e8 b0 d9 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
8010586d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105870:	89 04 24             	mov    %eax,(%esp)
80105873:	e8 f0 bf ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105878:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010587f:	66 83 f8 01          	cmp    $0x1,%ax
80105883:	75 1a                	jne    8010589f <sys_link+0x93>
    iunlockput(ip);
80105885:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105888:	89 04 24             	mov    %eax,(%esp)
8010588b:	e8 5c c2 ff ff       	call   80101aec <iunlockput>
    commit_trans();
80105890:	e8 d1 d9 ff ff       	call   80103266 <commit_trans>
    return -1;
80105895:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010589a:	e9 e7 00 00 00       	jmp    80105986 <sys_link+0x17a>
  }
...
801058ac:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801058b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b3:	89 04 24             	mov    %eax,(%esp)
801058b6:	e8 f1 bd ff ff       	call   801016ac <iupdate>
  iunlock(ip);
801058bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058be:	89 04 24             	mov    %eax,(%esp)
801058c1:	e8 f0 c0 ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801058c6:	8b 45 dc             	mov    -0x24(%ebp),%eax
801058c9:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801058cc:	89 54 24 04          	mov    %edx,0x4(%esp)
801058d0:	89 04 24             	mov    %eax,(%esp)
801058d3:	e8 54 cb ff ff       	call   8010242c <nameiparent>
801058d8:	89 45 f0             	mov    %eax,-0x10(%ebp)
801058db:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801058df:	74 68                	je     80105949 <sys_link+0x13d>
    goto bad;
  ilock(dp);
801058e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058e4:	89 04 24             	mov    %eax,(%esp)
801058e7:	e8 7c bf ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801058ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058ef:	8b 10                	mov    (%eax),%edx
801058f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058f4:	8b 00                	mov    (%eax),%eax
801058f6:	39 c2                	cmp    %eax,%edx
801058f8:	75 20                	jne    8010591a <sys_link+0x10e>
801058fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058fd:	8b 40 04             	mov    0x4(%eax),%eax
80105900:	89 44 24 08          	mov    %eax,0x8(%esp)
80105904:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105907:	89 44 24 04          	mov    %eax,0x4(%esp)
8010590b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010590e:	89 04 24             	mov    %eax,(%esp)
80105911:	e8 33 c8 ff ff       	call   80102149 <dirlink>
80105916:	85 c0                	test   %eax,%eax
80105918:	79 0d                	jns    80105927 <sys_link+0x11b>
    iunlockput(dp);
8010591a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010591d:	89 04 24             	mov    %eax,(%esp)
80105920:	e8 c7 c1 ff ff       	call   80101aec <iunlockput>
    goto bad;
80105925:	eb 23                	jmp    8010594a <sys_link+0x13e>
  }
  iunlockput(dp);
80105927:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010592a:	89 04 24             	mov    %eax,(%esp)
8010592d:	e8 ba c1 ff ff       	call   80101aec <iunlockput>
  iput(ip);
80105932:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105935:	89 04 24             	mov    %eax,(%esp)
80105938:	e8 de c0 ff ff       	call   80101a1b <iput>
...
80105947:	eb 3d                	jmp    80105986 <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105950:	e8 13 bf ff ff       	call   80101868 <ilock>
  ip->nlink--;
80105955:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105958:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010595c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010595f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105962:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105966:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105969:	89 04 24             	mov    %eax,(%esp)
8010596c:	e8 3b bd ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105971:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105974:	89 04 24             	mov    %eax,(%esp)
80105977:	e8 70 c1 ff ff       	call   80101aec <iunlockput>
  commit_trans();
8010597c:	e8 e5 d8 ff ff       	call   80103266 <commit_trans>
  return -1;
...
8010598e:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105995:	eb 4b                	jmp    801059e2 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105997:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010599a:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801059a1:	00 
...
801059b3:	e8 a6 c3 ff ff       	call   80101d5e <readi>
801059b8:	83 f8 10             	cmp    $0x10,%eax
801059bb:	74 0c                	je     801059c9 <isdirempty+0x41>
      panic("isdirempty: readi");
801059bd:	c7 04 24 e0 88 10 80 	movl   $0x801088e0,(%esp)
801059c4:	e8 74 ab ff ff       	call   8010053d <panic>
    if(de.inum != 0)
801059c9:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801059cd:	66 85 c0             	test   %ax,%ax
801059d0:	74 07                	je     801059d9 <isdirempty+0x51>
      return 0;
801059d2:	b8 00 00 00 00       	mov    $0x0,%eax
801059d7:	eb 1b                	jmp    801059f4 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801059dc:	83 c0 10             	add    $0x10,%eax
801059df:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059e2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059e5:	8b 45 08             	mov    0x8(%ebp),%eax
801059e8:	8b 40 18             	mov    0x18(%eax),%eax
801059eb:	39 c2                	cmp    %eax,%edx
801059ed:	72 a8                	jb     80105997 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801059ef:	b8 01 00 00 00       	mov    $0x1,%eax
}
801059f4:	c9                   	leave  
801059f5:	c3                   	ret    
...
801059f9:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801059fc:	8d 45 cc             	lea    -0x34(%ebp),%eax
801059ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a03:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a0a:	e8 43 fa ff ff       	call   80105452 <argstr>
80105a0f:	85 c0                	test   %eax,%eax
80105a11:	79 0a                	jns    80105a1d <sys_unlink+0x27>
    return -1;
80105a13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a18:	e9 aa 01 00 00       	jmp    80105bc7 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105a1d:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105a20:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105a23:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a27:	89 04 24             	mov    %eax,(%esp)
80105a2a:	e8 fd c9 ff ff       	call   8010242c <nameiparent>
80105a2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a32:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a36:	75 0a                	jne    80105a42 <sys_unlink+0x4c>
    return -1;
80105a38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a3d:	e9 85 01 00 00       	jmp    80105bc7 <sys_unlink+0x1d1>

  begin_trans();
80105a42:	e8 d6 d7 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
80105a47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a4a:	89 04 24             	mov    %eax,(%esp)
80105a4d:	e8 16 be ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a52:	c7 44 24 04 f2 88 10 	movl   $0x801088f2,0x4(%esp)
80105a59:	80 
80105a5a:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a5d:	89 04 24             	mov    %eax,(%esp)
80105a60:	e8 fa c5 ff ff       	call   8010205f <namecmp>
80105a65:	85 c0                	test   %eax,%eax
80105a67:	0f 84 45 01 00 00    	je     80105bb2 <sys_unlink+0x1bc>
80105a6d:	c7 44 24 04 f4 88 10 	movl   $0x801088f4,0x4(%esp)
80105a74:	80 
80105a75:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a78:	89 04 24             	mov    %eax,(%esp)
80105a7b:	e8 df c5 ff ff       	call   8010205f <namecmp>
80105a80:	85 c0                	test   %eax,%eax
80105a82:	0f 84 2a 01 00 00    	je     80105bb2 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105a88:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105a8b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a8f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a92:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a99:	89 04 24             	mov    %eax,(%esp)
80105a9c:	e8 e0 c5 ff ff       	call   80102081 <dirlookup>
80105aa1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105aa4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105aa8:	0f 84 03 01 00 00    	je     80105bb1 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105aae:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ab1:	89 04 24             	mov    %eax,(%esp)
80105ab4:	e8 af bd ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80105ab9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105abc:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105ac0:	66 85 c0             	test   %ax,%ax
80105ac3:	7f 0c                	jg     80105ad1 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105ac5:	c7 04 24 f7 88 10 80 	movl   $0x801088f7,(%esp)
80105acc:	e8 6c aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105ad1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ad4:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ad8:	66 83 f8 01          	cmp    $0x1,%ax
80105adc:	75 1f                	jne    80105afd <sys_unlink+0x107>
80105ade:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ae1:	89 04 24             	mov    %eax,(%esp)
80105ae4:	e8 9f fe ff ff       	call   80105988 <isdirempty>
80105ae9:	85 c0                	test   %eax,%eax
80105aeb:	75 10                	jne    80105afd <sys_unlink+0x107>
    iunlockput(ip);
80105aed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105af0:	89 04 24             	mov    %eax,(%esp)
80105af3:	e8 f4 bf ff ff       	call   80101aec <iunlockput>
    goto bad;
80105af8:	e9 b5 00 00 00       	jmp    80105bb2 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105afd:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b04:	00 
80105b05:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b0c:	00 
80105b0d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b10:	89 04 24             	mov    %eax,(%esp)
80105b13:	e8 4e f5 ff ff       	call   80105066 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b18:	8b 45 c8             	mov    -0x38(%ebp),%eax
...
80105b34:	e8 90 c3 ff ff       	call   80101ec9 <writei>
80105b39:	83 f8 10             	cmp    $0x10,%eax
80105b3c:	74 0c                	je     80105b4a <sys_unlink+0x154>
    panic("unlink: writei");
80105b3e:	c7 04 24 09 89 10 80 	movl   $0x80108909,(%esp)
80105b45:	e8 f3 a9 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105b4a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b4d:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b51:	66 83 f8 01          	cmp    $0x1,%ax
80105b55:	75 1c                	jne    80105b73 <sys_unlink+0x17d>
    dp->nlink--;
80105b57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b5e:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105b6e:	e8 39 bb ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
...
80105b95:	e8 12 bb ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105b9a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b9d:	89 04 24             	mov    %eax,(%esp)
80105ba0:	e8 47 bf ff ff       	call   80101aec <iunlockput>

  commit_trans();
80105ba5:	e8 bc d6 ff ff       	call   80103266 <commit_trans>

  return 0;
80105baa:	b8 00 00 00 00       	mov    $0x0,%eax
80105baf:	eb 16                	jmp    80105bc7 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105bb8:	e8 2f bf ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105bbd:	e8 a4 d6 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80105bcc:	83 ec 48             	sub    $0x48,%esp
80105bcf:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105bd2:	8b 55 10             	mov    0x10(%ebp),%edx
80105bd5:	8b 45 14             	mov    0x14(%ebp),%eax
80105bd8:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105bdc:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105be0:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105be4:	8d 45 de             	lea    -0x22(%ebp),%eax
80105be7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105beb:	8b 45 08             	mov    0x8(%ebp),%eax
80105bee:	89 04 24             	mov    %eax,(%esp)
80105bf1:	e8 36 c8 ff ff       	call   8010242c <nameiparent>
80105bf6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bf9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bfd:	75 0a                	jne    80105c09 <create+0x40>
    return 0;
80105bff:	b8 00 00 00 00       	mov    $0x0,%eax
80105c04:	e9 7e 01 00 00       	jmp    80105d87 <create+0x1be>
  ilock(dp);
80105c09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c0c:	89 04 24             	mov    %eax,(%esp)
80105c0f:	e8 54 bc ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105c14:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c17:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c1b:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c25:	89 04 24             	mov    %eax,(%esp)
80105c28:	e8 54 c4 ff ff       	call   80102081 <dirlookup>
80105c2d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c30:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c34:	74 47                	je     80105c7d <create+0xb4>
    iunlockput(dp);
...
80105c47:	e8 1c bc ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c4c:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c51:	75 15                	jne    80105c68 <create+0x9f>
80105c53:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c56:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c5a:	66 83 f8 02          	cmp    $0x2,%ax
80105c5e:	75 08                	jne    80105c68 <create+0x9f>
      return ip;
80105c60:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c63:	e9 1f 01 00 00       	jmp    80105d87 <create+0x1be>
    iunlockput(ip);
80105c68:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c6b:	89 04 24             	mov    %eax,(%esp)
80105c6e:	e8 79 be ff ff       	call   80101aec <iunlockput>
    return 0;
80105c73:	b8 00 00 00 00       	mov    $0x0,%eax
80105c78:	e9 0a 01 00 00       	jmp    80105d87 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105c7d:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80105c8d:	e8 3d b9 ff ff       	call   801015cf <ialloc>
80105c92:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c95:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c99:	75 0c                	jne    80105ca7 <create+0xde>
    panic("create: ialloc");
80105c9b:	c7 04 24 18 89 10 80 	movl   $0x80108918,(%esp)
80105ca2:	e8 96 a8 ff ff       	call   8010053d <panic>

  ilock(ip);
80105ca7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105caa:	89 04 24             	mov    %eax,(%esp)
80105cad:	e8 b6 bb ff ff       	call   80101868 <ilock>
  ip->major = major;
80105cb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb5:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105cb9:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105cbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc0:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105cc4:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105cc8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ccb:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105cd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd4:	89 04 24             	mov    %eax,(%esp)
80105cd7:	e8 d0 b9 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105cdc:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105ce1:	75 6a                	jne    80105d4d <create+0x184>
    dp->nlink++;  // for ".."
...
80105cfa:	e8 ad b9 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105cff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d02:	8b 40 04             	mov    0x4(%eax),%eax
80105d05:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d09:	c7 44 24 04 f2 88 10 	movl   $0x801088f2,0x4(%esp)
80105d10:	80 
80105d11:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d14:	89 04 24             	mov    %eax,(%esp)
80105d17:	e8 2d c4 ff ff       	call   80102149 <dirlink>
80105d1c:	85 c0                	test   %eax,%eax
80105d1e:	78 21                	js     80105d41 <create+0x178>
80105d20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d23:	8b 40 04             	mov    0x4(%eax),%eax
80105d26:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d2a:	c7 44 24 04 f4 88 10 	movl   $0x801088f4,0x4(%esp)
80105d31:	80 
80105d32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d35:	89 04 24             	mov    %eax,(%esp)
80105d38:	e8 0c c4 ff ff       	call   80102149 <dirlink>
80105d3d:	85 c0                	test   %eax,%eax
80105d3f:	79 0c                	jns    80105d4d <create+0x184>
      panic("create dots");
80105d41:	c7 04 24 27 89 10 80 	movl   $0x80108927,(%esp)
80105d48:	e8 f0 a7 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d50:	8b 40 04             	mov    0x4(%eax),%eax
80105d53:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105d64:	e8 e0 c3 ff ff       	call   80102149 <dirlink>
80105d69:	85 c0                	test   %eax,%eax
80105d6b:	79 0c                	jns    80105d79 <create+0x1b0>
    panic("create: dirlink");
80105d6d:	c7 04 24 33 89 10 80 	movl   $0x80108933,(%esp)
80105d74:	e8 c4 a7 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105d79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d7c:	89 04 24             	mov    %eax,(%esp)
80105d7f:	e8 68 bd ff ff       	call   80101aec <iunlockput>
...
80105d8f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105d92:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d96:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d9d:	e8 b0 f6 ff ff       	call   80105452 <argstr>
80105da2:	85 c0                	test   %eax,%eax
80105da4:	78 17                	js     80105dbd <sys_open+0x34>
80105da6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105da9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105db4:	e8 09 f6 ff ff       	call   801053c2 <argint>
80105db9:	85 c0                	test   %eax,%eax
80105dbb:	79 0a                	jns    80105dc7 <sys_open+0x3e>
    return -1;
80105dbd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dc2:	e9 46 01 00 00       	jmp    80105f0d <sys_open+0x184>
  if(omode & O_CREATE){
80105dc7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105dca:	25 00 02 00 00       	and    $0x200,%eax
80105dcf:	85 c0                	test   %eax,%eax
80105dd1:	74 40                	je     80105e13 <sys_open+0x8a>
    begin_trans();
80105dd3:	e8 45 d4 ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105dd8:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ddb:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105de2:	00 
80105de3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105dea:	00 
80105deb:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105df2:	00 
80105df3:	89 04 24             	mov    %eax,(%esp)
80105df6:	e8 ce fd ff ff       	call   80105bc9 <create>
80105dfb:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105dfe:	e8 63 d4 ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
80105e03:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e07:	75 5c                	jne    80105e65 <sys_open+0xdc>
      return -1;
80105e09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e0e:	e9 fa 00 00 00       	jmp    80105f0d <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80105e13:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e16:	89 04 24             	mov    %eax,(%esp)
80105e19:	e8 ec c5 ff ff       	call   8010240a <namei>
80105e1e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e21:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e25:	75 0a                	jne    80105e31 <sys_open+0xa8>
      return -1;
80105e27:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e2c:	e9 dc 00 00 00       	jmp    80105f0d <sys_open+0x184>
    ilock(ip);
80105e31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e34:	89 04 24             	mov    %eax,(%esp)
80105e37:	e8 2c ba ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e3f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e43:	66 83 f8 01          	cmp    $0x1,%ax
80105e47:	75 1c                	jne    80105e65 <sys_open+0xdc>
80105e49:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e4c:	85 c0                	test   %eax,%eax
80105e4e:	74 15                	je     80105e65 <sys_open+0xdc>
      iunlockput(ip);
80105e50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e53:	89 04 24             	mov    %eax,(%esp)
80105e56:	e8 91 bc ff ff       	call   80101aec <iunlockput>
      return -1;
80105e5b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e60:	e9 a8 00 00 00       	jmp    80105f0d <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105e65:	e8 b2 b0 ff ff       	call   80100f1c <filealloc>
80105e6a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e6d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e71:	74 14                	je     80105e87 <sys_open+0xfe>
80105e73:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e76:	89 04 24             	mov    %eax,(%esp)
80105e79:	e8 43 f7 ff ff       	call   801055c1 <fdalloc>
80105e7e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105e81:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105e85:	79 23                	jns    80105eaa <sys_open+0x121>
    if(f)
80105e87:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e8b:	74 0b                	je     80105e98 <sys_open+0x10f>
      fileclose(f);
80105e8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e90:	89 04 24             	mov    %eax,(%esp)
80105e93:	e8 2c b1 ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
80105e98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e9b:	89 04 24             	mov    %eax,(%esp)
80105e9e:	e8 49 bc ff ff       	call   80101aec <iunlockput>
    return -1;
80105ea3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ea8:	eb 63                	jmp    80105f0d <sys_open+0x184>
  }
  iunlock(ip);
80105eaa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ead:	89 04 24             	mov    %eax,(%esp)
80105eb0:	e8 01 bb ff ff       	call   801019b6 <iunlock>
...
80105ed9:	0f 94 c2             	sete   %dl
80105edc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105edf:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105ee2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ee5:	83 e0 01             	and    $0x1,%eax
80105ee8:	84 c0                	test   %al,%al
80105eea:	75 0a                	jne    80105ef6 <sys_open+0x16d>
80105eec:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105eef:	83 e0 02             	and    $0x2,%eax
80105ef2:	85 c0                	test   %eax,%eax
80105ef4:	74 07                	je     80105efd <sys_open+0x174>
80105ef6:	b8 01 00 00 00       	mov    $0x1,%eax
80105efb:	eb 05                	jmp    80105f02 <sys_open+0x179>
80105efd:	b8 00 00 00 00       	mov    $0x0,%eax
80105f02:	89 c2                	mov    %eax,%edx
80105f04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f07:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105f0a:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105f0d:	c9                   	leave  
80105f0e:	c3                   	ret    
...
80105f12:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
80105f15:	e8 03 d3 ff ff       	call   8010321d <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80105f1a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105f1d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f21:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f28:	e8 25 f5 ff ff       	call   80105452 <argstr>
80105f2d:	85 c0                	test   %eax,%eax
80105f2f:	78 2c                	js     80105f5d <sys_mkdir+0x4e>
...
80105f83:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_trans();
80105f86:	e8 92 d2 ff ff       	call   8010321d <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80105f8b:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105f8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f92:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f99:	e8 b4 f4 ff ff       	call   80105452 <argstr>
80105f9e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fa1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fa5:	78 5e                	js     80106005 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80105fa7:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105faa:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fb5:	e8 08 f4 ff ff       	call   801053c2 <argint>
  char *path;
  int len;
  int major, minor;
...
80105fbc:	78 47                	js     80106005 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fbe:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105fc1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fc5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105fcc:	e8 f1 f3 ff ff       	call   801053c2 <argint>
  int len;
  int major, minor;
...
80105fd3:	78 30                	js     80106005 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105fd5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fd8:	0f bf c8             	movswl %ax,%ecx
80105fdb:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105fde:	0f bf d0             	movswl %ax,%edx
80105fe1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fe4:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105fe8:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fec:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105ff3:	00 
80105ff4:	89 04 24             	mov    %eax,(%esp)
80105ff7:	e8 cd fb ff ff       	call   80105bc9 <create>
80105ffc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106003:	75 0c                	jne    80106011 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80106005:	e8 5c d2 ff ff       	call   80103266 <commit_trans>
    return -1;
8010600a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010600f:	eb 15                	jmp    80106026 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106011:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106014:	89 04 24             	mov    %eax,(%esp)
80106017:	e8 d0 ba ff ff       	call   80101aec <iunlockput>
  commit_trans();
8010601c:	e8 45 d2 ff ff       	call   80103266 <commit_trans>
  return 0;
...
80106031:	89 44 24 04          	mov    %eax,0x4(%esp)
80106035:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010603c:	e8 11 f4 ff ff       	call   80105452 <argstr>
80106041:	85 c0                	test   %eax,%eax
80106043:	78 14                	js     80106059 <sys_chdir+0x31>
80106045:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106048:	89 04 24             	mov    %eax,(%esp)
8010604b:	e8 ba c3 ff ff       	call   8010240a <namei>
80106050:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106053:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106057:	75 07                	jne    80106060 <sys_chdir+0x38>
    return -1;
80106059:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010605e:	eb 57                	jmp    801060b7 <sys_chdir+0x8f>
  ilock(ip);
80106060:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106063:	89 04 24             	mov    %eax,(%esp)
80106066:	e8 fd b7 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
8010606b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010606e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106072:	66 83 f8 01          	cmp    $0x1,%ax
80106076:	74 12                	je     8010608a <sys_chdir+0x62>
    iunlockput(ip);
...
80106088:	eb 2d                	jmp    801060b7 <sys_chdir+0x8f>
  }
  iunlock(ip);
8010608a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010608d:	89 04 24             	mov    %eax,(%esp)
80106090:	e8 21 b9 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
80106095:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010609b:	8b 40 68             	mov    0x68(%eax),%eax
8010609e:	89 04 24             	mov    %eax,(%esp)
801060a1:	e8 75 b9 ff ff       	call   80101a1b <iput>
  proc->cwd = ip;
801060a6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060ac:	8b 55 f4             	mov    -0xc(%ebp),%edx
801060af:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
801060bc:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801060d0:	e8 7d f3 ff ff       	call   80105452 <argstr>
801060d5:	85 c0                	test   %eax,%eax
801060d7:	78 1a                	js     801060f3 <sys_exec+0x3a>
801060d9:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801060df:	89 44 24 04          	mov    %eax,0x4(%esp)
801060e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060ea:	e8 d3 f2 ff ff       	call   801053c2 <argint>
801060ef:	85 c0                	test   %eax,%eax
801060f1:	79 0a                	jns    801060fd <sys_exec+0x44>
    return -1;
801060f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f8:	e9 cc 00 00 00       	jmp    801061c9 <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
801060fd:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106104:	00 
80106105:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010610c:	00 
8010610d:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106113:	89 04 24             	mov    %eax,(%esp)
80106116:	e8 4b ef ff ff       	call   80105066 <memset>
  for(i=0;; i++){
8010611b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106122:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106125:	83 f8 1f             	cmp    $0x1f,%eax
80106128:	76 0a                	jbe    80106134 <sys_exec+0x7b>
      return -1;
8010612a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010612f:	e9 95 00 00 00       	jmp    801061c9 <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106134:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106137:	c1 e0 02             	shl    $0x2,%eax
8010613a:	89 c2                	mov    %eax,%edx
8010613c:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106142:	01 c2                	add    %eax,%edx
80106144:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010614a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010614e:	89 14 24             	mov    %edx,(%esp)
80106151:	e8 ce f1 ff ff       	call   80105324 <fetchint>
80106156:	85 c0                	test   %eax,%eax
80106158:	79 07                	jns    80106161 <sys_exec+0xa8>
      return -1;
8010615a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010615f:	eb 68                	jmp    801061c9 <sys_exec+0x110>
    if(uarg == 0){
80106161:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106167:	85 c0                	test   %eax,%eax
80106169:	75 26                	jne    80106191 <sys_exec+0xd8>
      argv[i] = 0;
8010616b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010616e:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106175:	00 00 00 00 
      break;
80106179:	90                   	nop
    }
...
8010617d:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106183:	89 54 24 04          	mov    %edx,0x4(%esp)
80106187:	89 04 24             	mov    %eax,(%esp)
8010618a:	e8 6d a9 ff ff       	call   80100afc <exec>
8010618f:	eb 38                	jmp    801061c9 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106194:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010619b:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061a1:	01 c2                	add    %eax,%edx
801061a3:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801061a9:	89 54 24 04          	mov    %edx,0x4(%esp)
801061ad:	89 04 24             	mov    %eax,(%esp)
801061b0:	e8 a9 f1 ff ff       	call   8010535e <fetchstr>
801061b5:	85 c0                	test   %eax,%eax
801061b7:	79 07                	jns    801061c0 <sys_exec+0x107>
      return -1;
801061b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061be:	eb 09                	jmp    801061c9 <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801061c0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
801061c4:	e9 59 ff ff ff       	jmp    80106122 <sys_exec+0x69>
  return exec(path, argv);
}
801061c9:	c9                   	leave  
801061ca:	c3                   	ret    
...
801061d1:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801061d8:	00 
801061d9:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801061e0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061e7:	e8 04 f2 ff ff       	call   801053f0 <argptr>
801061ec:	85 c0                	test   %eax,%eax
801061ee:	79 0a                	jns    801061fa <sys_pipe+0x2f>
    return -1;
801061f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061f5:	e9 9b 00 00 00       	jmp    80106295 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801061fa:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801061fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106201:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106204:	89 04 24             	mov    %eax,(%esp)
80106207:	e8 2c da ff ff       	call   80103c38 <pipealloc>
8010620c:	85 c0                	test   %eax,%eax
8010620e:	79 07                	jns    80106217 <sys_pipe+0x4c>
    return -1;
80106210:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106215:	eb 7e                	jmp    80106295 <sys_pipe+0xca>
  fd0 = -1;
80106217:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010621e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106221:	89 04 24             	mov    %eax,(%esp)
80106224:	e8 98 f3 ff ff       	call   801055c1 <fdalloc>
80106229:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010622c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106230:	78 14                	js     80106246 <sys_pipe+0x7b>
80106232:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106235:	89 04 24             	mov    %eax,(%esp)
80106238:	e8 84 f3 ff ff       	call   801055c1 <fdalloc>
8010623d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106240:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106244:	79 37                	jns    8010627d <sys_pipe+0xb2>
    if(fd0 >= 0)
80106246:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010624a:	78 14                	js     80106260 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010624c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106252:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106255:	83 c2 08             	add    $0x8,%edx
80106258:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010625f:	00 
    fileclose(rf);
80106260:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106263:	89 04 24             	mov    %eax,(%esp)
80106266:	e8 59 ad ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
8010626b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010626e:	89 04 24             	mov    %eax,(%esp)
80106271:	e8 4e ad ff ff       	call   80100fc4 <fileclose>
    return -1;
80106276:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010627b:	eb 18                	jmp    80106295 <sys_pipe+0xca>
  }
  fd[0] = fd0;
8010627d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106280:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106283:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106285:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106288:	8d 50 04             	lea    0x4(%eax),%edx
...
8010629b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010629e:	e8 10 e2 ff ff       	call   801044b3 <fork>
}
801062a3:	c9                   	leave  
801062a4:	c3                   	ret    
...
801062a8:	83 ec 08             	sub    $0x8,%esp
  exit();
801062ab:	e8 6f e3 ff ff       	call   8010461f <exit>
...
801062ba:	83 ec 08             	sub    $0x8,%esp
  return wait();
801062bd:	e8 78 e4 ff ff       	call   8010473a <wait>
}
801062c2:	c9                   	leave  
801062c3:	c3                   	ret    
...
801062d8:	e8 e5 f0 ff ff       	call   801053c2 <argint>
...
801062ee:	e8 1f e9 ff ff       	call   80104c12 <kill>
}
801062f3:	c9                   	leave  
801062f4:	c3                   	ret    
...
80106317:	e8 a6 f0 ff ff       	call   801053c2 <argint>
...
80106338:	e8 d1 e0 ff ff       	call   8010440e <growproc>
...
80106361:	e8 5c f0 ff ff       	call   801053c2 <argint>
...
8010636f:	eb 6c                	jmp    801063dd <sys_sleep+0x90>
  acquire(&tickslock);
80106371:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
80106378:	e8 9a ea ff ff       	call   80104e17 <acquire>
  ticks0 = ticks;
8010637d:	a1 c0 29 11 80       	mov    0x801129c0,%eax
...
80106392:	74 13                	je     801063a7 <sys_sleep+0x5a>
      release(&tickslock);
80106394:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
8010639b:	e8 d9 ea ff ff       	call   80104e79 <release>
      return -1;
801063a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063a5:	eb 36                	jmp    801063dd <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801063a7:	c7 44 24 04 80 21 11 	movl   $0x80112180,0x4(%esp)
801063ae:	80 
801063af:	c7 04 24 c0 29 11 80 	movl   $0x801129c0,(%esp)
801063b6:	e8 40 e7 ff ff       	call   80104afb <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801063bb:	a1 c0 29 11 80       	mov    0x801129c0,%eax
801063c0:	89 c2                	mov    %eax,%edx
801063c2:	2b 55 f4             	sub    -0xc(%ebp),%edx
...
801063ca:	72 bb                	jb     80106387 <sys_sleep+0x3a>
  ...
  release(&tickslock);
801063cc:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
801063d3:	e8 a1 ea ff ff       	call   80104e79 <release>
  return 0;
...
801063e2:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  acquire(&tickslock);
801063e5:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
801063ec:	e8 26 ea ff ff       	call   80104e17 <acquire>
  xticks = ticks;
801063f1:	a1 c0 29 11 80       	mov    0x801129c0,%eax
801063f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063f9:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
80106400:	e8 74 ea ff ff       	call   80104e79 <release>
  return xticks;
...
8010640d:	83 ec 08             	sub    $0x8,%esp
	procdump();
80106410:	e8 9c e8 ff ff       	call   80104cb1 <procdump>
	return(0);
...
80106430:	e8 8d ef ff ff       	call   801053c2 <argint>
80106435:	85 c0                	test   %eax,%eax
80106437:	79 07                	jns    80106440 <sys_set_priority+0x24>
		return(-1);	
80106439:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010643e:	eb 18                	jmp    80106458 <sys_set_priority+0x3c>
	cprintf("El parametro de set priority es:    %d     # \n",p);
80106440:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106443:	89 44 24 04          	mov    %eax,0x4(%esp)
80106447:	c7 04 24 44 89 10 80 	movl   $0x80108944,(%esp)
8010644e:	e8 4e 9f ff ff       	call   801003a1 <cprintf>
	return (0);
...
80106468:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010646c:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010646f:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106473:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106477:	ee                   	out    %al,(%dx)
}
80106478:	c9                   	leave  
80106479:	c3                   	ret    
...
80106480:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106487:	00 
80106488:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010648f:	e8 c8 ff ff ff       	call   8010645c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106494:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010649b:	00 
8010649c:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064a3:	e8 b4 ff ff ff       	call   8010645c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801064a8:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801064af:	00 
801064b0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064b7:	e8 a0 ff ff ff       	call   8010645c <outb>
  picenable(IRQ_TIMER);
801064bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064c3:	e8 f9 d5 ff ff       	call   80103ac1 <picenable>
}
801064c8:	c9                   	leave  
801064c9:	c3                   	ret    
	...
...
801064cd:	06                   	push   %es
  pushl %fs
801064ce:	0f a0                	push   %fs
  pushl %gs
801064d0:	0f a8                	push   %gs
  pushal
801064d2:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801064d3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801064d7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801064d9:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801064db:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801064df:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801064e1:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801064e3:	54                   	push   %esp
  call trap
801064e4:	e8 de 01 00 00       	call   801066c7 <trap>
  addl $4, %esp
801064e9:	83 c4 04             	add    $0x4,%esp
...
801064ec:	61                   	popa   
  popl %gs
801064ed:	0f a9                	pop    %gs
  popl %fs
801064ef:	0f a1                	pop    %fs
  popl %es
801064f1:	07                   	pop    %es
  popl %ds
801064f2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801064f3:	83 c4 08             	add    $0x8,%esp
  iret
801064f6:	cf                   	iret   
	...
...
801064fb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801064fe:	8b 45 0c             	mov    0xc(%ebp),%eax
80106501:	83 e8 01             	sub    $0x1,%eax
80106504:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106508:	8b 45 08             	mov    0x8(%ebp),%eax
8010650b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010650f:	8b 45 08             	mov    0x8(%ebp),%eax
80106512:	c1 e8 10             	shr    $0x10,%eax
80106515:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106519:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010651c:	0f 01 18             	lidtl  (%eax)
}
8010651f:	c9                   	leave  
80106520:	c3                   	ret    
...
80106525:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106528:	0f 20 d3             	mov    %cr2,%ebx
8010652b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
8010652e:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106544:	e9 c3 00 00 00       	jmp    8010660c <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106549:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654c:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
80106553:	89 c2                	mov    %eax,%edx
80106555:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106558:	66 89 14 c5 c0 21 11 	mov    %dx,-0x7feede40(,%eax,8)
8010655f:	80 
80106560:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106563:	66 c7 04 c5 c2 21 11 	movw   $0x8,-0x7feede3e(,%eax,8)
8010656a:	80 08 00 
8010656d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106570:	0f b6 14 c5 c4 21 11 	movzbl -0x7feede3c(,%eax,8),%edx
80106577:	80 
80106578:	83 e2 e0             	and    $0xffffffe0,%edx
8010657b:	88 14 c5 c4 21 11 80 	mov    %dl,-0x7feede3c(,%eax,8)
80106582:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106585:	0f b6 14 c5 c4 21 11 	movzbl -0x7feede3c(,%eax,8),%edx
8010658c:	80 
8010658d:	83 e2 1f             	and    $0x1f,%edx
80106590:	88 14 c5 c4 21 11 80 	mov    %dl,-0x7feede3c(,%eax,8)
80106597:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010659a:	0f b6 14 c5 c5 21 11 	movzbl -0x7feede3b(,%eax,8),%edx
801065a1:	80 
801065a2:	83 e2 f0             	and    $0xfffffff0,%edx
801065a5:	83 ca 0e             	or     $0xe,%edx
801065a8:	88 14 c5 c5 21 11 80 	mov    %dl,-0x7feede3b(,%eax,8)
801065af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065b2:	0f b6 14 c5 c5 21 11 	movzbl -0x7feede3b(,%eax,8),%edx
801065b9:	80 
801065ba:	83 e2 ef             	and    $0xffffffef,%edx
801065bd:	88 14 c5 c5 21 11 80 	mov    %dl,-0x7feede3b(,%eax,8)
801065c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c7:	0f b6 14 c5 c5 21 11 	movzbl -0x7feede3b(,%eax,8),%edx
801065ce:	80 
801065cf:	83 e2 9f             	and    $0xffffff9f,%edx
801065d2:	88 14 c5 c5 21 11 80 	mov    %dl,-0x7feede3b(,%eax,8)
801065d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065dc:	0f b6 14 c5 c5 21 11 	movzbl -0x7feede3b(,%eax,8),%edx
801065e3:	80 
801065e4:	83 ca 80             	or     $0xffffff80,%edx
801065e7:	88 14 c5 c5 21 11 80 	mov    %dl,-0x7feede3b(,%eax,8)
801065ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f1:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
801065f8:	c1 e8 10             	shr    $0x10,%eax
801065fb:	89 c2                	mov    %eax,%edx
801065fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106600:	66 89 14 c5 c6 21 11 	mov    %dx,-0x7feede3a(,%eax,8)
80106607:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106608:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010660c:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106613:	0f 8e 30 ff ff ff    	jle    80106549 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106619:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
8010661e:	66 a3 c0 23 11 80    	mov    %ax,0x801123c0
80106624:	66 c7 05 c2 23 11 80 	movw   $0x8,0x801123c2
8010662b:	08 00 
8010662d:	0f b6 05 c4 23 11 80 	movzbl 0x801123c4,%eax
80106634:	83 e0 e0             	and    $0xffffffe0,%eax
80106637:	a2 c4 23 11 80       	mov    %al,0x801123c4
8010663c:	0f b6 05 c4 23 11 80 	movzbl 0x801123c4,%eax
80106643:	83 e0 1f             	and    $0x1f,%eax
80106646:	a2 c4 23 11 80       	mov    %al,0x801123c4
8010664b:	0f b6 05 c5 23 11 80 	movzbl 0x801123c5,%eax
80106652:	83 c8 0f             	or     $0xf,%eax
80106655:	a2 c5 23 11 80       	mov    %al,0x801123c5
8010665a:	0f b6 05 c5 23 11 80 	movzbl 0x801123c5,%eax
80106661:	83 e0 ef             	and    $0xffffffef,%eax
80106664:	a2 c5 23 11 80       	mov    %al,0x801123c5
80106669:	0f b6 05 c5 23 11 80 	movzbl 0x801123c5,%eax
80106670:	83 c8 60             	or     $0x60,%eax
80106673:	a2 c5 23 11 80       	mov    %al,0x801123c5
80106678:	0f b6 05 c5 23 11 80 	movzbl 0x801123c5,%eax
8010667f:	83 c8 80             	or     $0xffffff80,%eax
80106682:	a2 c5 23 11 80       	mov    %al,0x801123c5
80106687:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
8010668c:	c1 e8 10             	shr    $0x10,%eax
8010668f:	66 a3 c6 23 11 80    	mov    %ax,0x801123c6
  
  initlock(&tickslock, "time");
80106695:	c7 44 24 04 74 89 10 	movl   $0x80108974,0x4(%esp)
8010669c:	80 
8010669d:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
801066a4:	e8 4d e7 ff ff       	call   80104df6 <initlock>
}
801066a9:	c9                   	leave  
801066aa:	c3                   	ret    
...
801066ae:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801066b1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801066b8:	00 
801066b9:	c7 04 24 c0 21 11 80 	movl   $0x801121c0,(%esp)
801066c0:	e8 33 fe ff ff       	call   801064f8 <lidt>
}
801066c5:	c9                   	leave  
801066c6:	c3                   	ret    
...
801066cd:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801066d0:	8b 45 08             	mov    0x8(%ebp),%eax
801066d3:	8b 40 30             	mov    0x30(%eax),%eax
801066d6:	83 f8 40             	cmp    $0x40,%eax
801066d9:	75 3e                	jne    80106719 <trap+0x52>
    if(proc->killed)
801066db:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066e1:	8b 40 24             	mov    0x24(%eax),%eax
801066e4:	85 c0                	test   %eax,%eax
801066e6:	74 05                	je     801066ed <trap+0x26>
      exit();
801066e8:	e8 32 df ff ff       	call   8010461f <exit>
    proc->tf = tf;
801066ed:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066f3:	8b 55 08             	mov    0x8(%ebp),%edx
801066f6:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801066f9:	e8 8b ed ff ff       	call   80105489 <syscall>
    if(proc->killed)
801066fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106704:	8b 40 24             	mov    0x24(%eax),%eax
80106707:	85 c0                	test   %eax,%eax
80106709:	0f 84 58 02 00 00    	je     80106967 <trap+0x2a0>
      exit();
8010670f:	e8 0b df ff ff       	call   8010461f <exit>
    return;
80106714:	e9 4e 02 00 00       	jmp    80106967 <trap+0x2a0>
  }

  switch(tf->trapno){
80106719:	8b 45 08             	mov    0x8(%ebp),%eax
8010671c:	8b 40 30             	mov    0x30(%eax),%eax
8010671f:	83 e8 20             	sub    $0x20,%eax
80106722:	83 f8 1f             	cmp    $0x1f,%eax
80106725:	0f 87 bc 00 00 00    	ja     801067e7 <trap+0x120>
8010672b:	8b 04 85 1c 8a 10 80 	mov    -0x7fef75e4(,%eax,4),%eax
80106732:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106734:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010673a:	0f b6 00             	movzbl (%eax),%eax
8010673d:	84 c0                	test   %al,%al
8010673f:	75 31                	jne    80106772 <trap+0xab>
      acquire(&tickslock);
80106741:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
80106748:	e8 ca e6 ff ff       	call   80104e17 <acquire>
      ticks++;
8010674d:	a1 c0 29 11 80       	mov    0x801129c0,%eax
80106752:	83 c0 01             	add    $0x1,%eax
80106755:	a3 c0 29 11 80       	mov    %eax,0x801129c0
      wakeup(&ticks);
8010675a:	c7 04 24 c0 29 11 80 	movl   $0x801129c0,(%esp)
80106761:	e8 81 e4 ff ff       	call   80104be7 <wakeup>
      release(&tickslock);
80106766:	c7 04 24 80 21 11 80 	movl   $0x80112180,(%esp)
8010676d:	e8 07 e7 ff ff       	call   80104e79 <release>
    }
    lapiceoi();
80106772:	e8 72 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106777:	e9 41 01 00 00       	jmp    801068bd <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010677c:	e8 70 bf ff ff       	call   801026f1 <ideintr>
    lapiceoi();
80106781:	e8 63 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106786:	e9 32 01 00 00       	jmp    801068bd <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010678b:	e8 37 c5 ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
80106790:	e8 54 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106795:	e9 23 01 00 00       	jmp    801068bd <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010679a:	e8 cd 03 00 00       	call   80106b6c <uartintr>
    lapiceoi();
8010679f:	e8 45 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
801067a4:	e9 14 01 00 00       	jmp    801068bd <trap+0x1f6>
  case T_IRQ0 + 7:
...
801067a9:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067ac:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801067af:	8b 45 08             	mov    0x8(%ebp),%eax
801067b2:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067b6:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
801067bf:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801067c2:	0f b6 c0             	movzbl %al,%eax
801067c5:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801067c9:	89 54 24 08          	mov    %edx,0x8(%esp)
801067cd:	89 44 24 04          	mov    %eax,0x4(%esp)
801067d1:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
801067d8:	e8 c4 9b ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801067dd:	e8 07 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
801067e2:	e9 d6 00 00 00       	jmp    801068bd <trap+0x1f6>
...
801067ef:	74 11                	je     80106802 <trap+0x13b>
801067f1:	8b 45 08             	mov    0x8(%ebp),%eax
801067f4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801067f8:	0f b7 c0             	movzwl %ax,%eax
801067fb:	83 e0 03             	and    $0x3,%eax
801067fe:	85 c0                	test   %eax,%eax
80106800:	75 46                	jne    80106848 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106802:	e8 1a fd ff ff       	call   80106521 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80106807:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010680a:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010680d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106814:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106817:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
...
80106820:	89 44 24 10          	mov    %eax,0x10(%esp)
80106824:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106828:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010682c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106830:	c7 04 24 a0 89 10 80 	movl   $0x801089a0,(%esp)
80106837:	e8 65 9b ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010683c:	c7 04 24 d2 89 10 80 	movl   $0x801089d2,(%esp)
80106843:	e8 f5 9c ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106848:	e8 d4 fc ff ff       	call   80106521 <rcr2>
...
8010684f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106852:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106855:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010685b:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010685e:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106861:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106864:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106867:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010686a:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010686d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106873:	83 c0 6c             	add    $0x6c,%eax
80106876:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106879:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010687f:	8b 40 10             	mov    0x10(%eax),%eax
80106882:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106886:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010688a:	89 74 24 14          	mov    %esi,0x14(%esp)
8010688e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106892:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106896:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106899:	89 54 24 08          	mov    %edx,0x8(%esp)
8010689d:	89 44 24 04          	mov    %eax,0x4(%esp)
801068a1:	c7 04 24 d8 89 10 80 	movl   $0x801089d8,(%esp)
801068a8:	e8 f4 9a ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801068ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068b3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801068ba:	eb 01                	jmp    801068bd <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801068c5:	74 24                	je     801068eb <trap+0x224>
801068c7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068cd:	8b 40 24             	mov    0x24(%eax),%eax
801068d0:	85 c0                	test   %eax,%eax
801068d2:	74 17                	je     801068eb <trap+0x224>
801068d4:	8b 45 08             	mov    0x8(%ebp),%eax
801068d7:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068db:	0f b7 c0             	movzwl %ax,%eax
801068de:	83 e0 03             	and    $0x3,%eax
801068e1:	83 f8 03             	cmp    $0x3,%eax
801068e4:	75 05                	jne    801068eb <trap+0x224>
    exit();
801068e6:	e8 34 dd ff ff       	call   8010461f <exit>
...
801068f3:	74 42                	je     80106937 <trap+0x270>
801068f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068fb:	8b 40 0c             	mov    0xc(%eax),%eax
801068fe:	83 f8 04             	cmp    $0x4,%eax
80106901:	75 34                	jne    80106937 <trap+0x270>
80106903:	8b 45 08             	mov    0x8(%ebp),%eax
80106906:	8b 40 30             	mov    0x30(%eax),%eax
80106909:	83 f8 20             	cmp    $0x20,%eax
8010690c:	75 29                	jne    80106937 <trap+0x270>
	  proc->quantum+=1;
8010690e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106914:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010691b:	8b 52 7c             	mov    0x7c(%edx),%edx
8010691e:	83 c2 01             	add    $0x1,%edx
80106921:	89 50 7c             	mov    %edx,0x7c(%eax)
...
8010692a:	8b 40 7c             	mov    0x7c(%eax),%eax
8010692d:	83 f8 04             	cmp    $0x4,%eax
80106930:	75 05                	jne    80106937 <trap+0x270>
      {
   //  cprintf("El Proceso '%s', lleva el QUANTUM  %d    \n",proc->name,proc->quantum);
       yield();
80106932:	e8 52 e1 ff ff       	call   80104a89 <yield>
       }
	}
...
8010695e:	75 08                	jne    80106968 <trap+0x2a1>
    exit();
80106960:	e8 ba dc ff ff       	call   8010461f <exit>
80106965:	eb 01                	jmp    80106968 <trap+0x2a1>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106968:	83 c4 3c             	add    $0x3c,%esp
8010696b:	5b                   	pop    %ebx
8010696c:	5e                   	pop    %esi
8010696d:	5f                   	pop    %edi
8010696e:	5d                   	pop    %ebp
...
8010697a:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010697e:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106982:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106986:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010698a:	ec                   	in     (%dx),%al
8010698b:	89 c3                	mov    %eax,%ebx
8010698d:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106990:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106994:	83 c4 14             	add    $0x14,%esp
80106997:	5b                   	pop    %ebx
80106998:	5d                   	pop    %ebp
80106999:	c3                   	ret    
...
801069a0:	8b 55 08             	mov    0x8(%ebp),%edx
801069a3:	8b 45 0c             	mov    0xc(%ebp),%eax
801069a6:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801069aa:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801069ad:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801069b1:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801069b5:	ee                   	out    %al,(%dx)
}
801069b6:	c9                   	leave  
801069b7:	c3                   	ret    
...
801069bb:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
801069be:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069c5:	00 
801069c6:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801069cd:	e8 c8 ff ff ff       	call   8010699a <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801069d2:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801069d9:	00 
801069da:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801069e1:	e8 b4 ff ff ff       	call   8010699a <outb>
  outb(COM1+0, 115200/9600);
801069e6:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801069ed:	00 
801069ee:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069f5:	e8 a0 ff ff ff       	call   8010699a <outb>
  outb(COM1+1, 0);
801069fa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a01:	00 
80106a02:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a09:	e8 8c ff ff ff       	call   8010699a <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106a0e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106a15:	00 
80106a16:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106a1d:	e8 78 ff ff ff       	call   8010699a <outb>
  outb(COM1+4, 0);
80106a22:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a29:	00 
80106a2a:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106a31:	e8 64 ff ff ff       	call   8010699a <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106a36:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106a3d:	00 
80106a3e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a45:	e8 50 ff ff ff       	call   8010699a <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106a4a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a51:	e8 1a ff ff ff       	call   80106970 <inb>
80106a56:	3c ff                	cmp    $0xff,%al
80106a58:	74 6c                	je     80106ac6 <uartinit+0x10e>
    return;
  uart = 1;
80106a5a:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106a61:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106a64:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106a6b:	e8 00 ff ff ff       	call   80106970 <inb>
  inb(COM1+0);
80106a70:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a77:	e8 f4 fe ff ff       	call   80106970 <inb>
  picenable(IRQ_COM1);
80106a7c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a83:	e8 39 d0 ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106a88:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a8f:	00 
80106a90:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a97:	e8 da be ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a9c:	c7 45 f4 9c 8a 10 80 	movl   $0x80108a9c,-0xc(%ebp)
80106aa3:	eb 15                	jmp    80106aba <uartinit+0x102>
    uartputc(*p);
80106aa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aa8:	0f b6 00             	movzbl (%eax),%eax
80106aab:	0f be c0             	movsbl %al,%eax
80106aae:	89 04 24             	mov    %eax,(%esp)
80106ab1:	e8 13 00 00 00       	call   80106ac9 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106ab6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106aba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106abd:	0f b6 00             	movzbl (%eax),%eax
80106ac0:	84 c0                	test   %al,%al
80106ac2:	75 e1                	jne    80106aa5 <uartinit+0xed>
80106ac4:	eb 01                	jmp    80106ac7 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106acc:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106acf:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106ad4:	85 c0                	test   %eax,%eax
80106ad6:	74 4d                	je     80106b25 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106ad8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106adf:	eb 10                	jmp    80106af1 <uartputc+0x28>
    microdelay(10);
80106ae1:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106ae8:	e8 21 c4 ff ff       	call   80102f0e <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106aed:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106af1:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106af5:	7f 16                	jg     80106b0d <uartputc+0x44>
80106af7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106afe:	e8 6d fe ff ff       	call   80106970 <inb>
80106b03:	0f b6 c0             	movzbl %al,%eax
80106b06:	83 e0 20             	and    $0x20,%eax
80106b09:	85 c0                	test   %eax,%eax
80106b0b:	74 d4                	je     80106ae1 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80106b0d:	8b 45 08             	mov    0x8(%ebp),%eax
80106b10:	0f b6 c0             	movzbl %al,%eax
80106b13:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b17:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b1e:	e8 77 fe ff ff       	call   8010699a <outb>
80106b23:	eb 01                	jmp    80106b26 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106b2b:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106b2e:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106b33:	85 c0                	test   %eax,%eax
80106b35:	75 07                	jne    80106b3e <uartgetc+0x16>
    return -1;
80106b37:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b3c:	eb 2c                	jmp    80106b6a <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106b3e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b45:	e8 26 fe ff ff       	call   80106970 <inb>
80106b4a:	0f b6 c0             	movzbl %al,%eax
80106b4d:	83 e0 01             	and    $0x1,%eax
80106b50:	85 c0                	test   %eax,%eax
80106b52:	75 07                	jne    80106b5b <uartgetc+0x33>
    return -1;
80106b54:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b59:	eb 0f                	jmp    80106b6a <uartgetc+0x42>
  return inb(COM1+0);
80106b5b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b62:	e8 09 fe ff ff       	call   80106970 <inb>
...
80106b6f:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106b72:	c7 04 24 28 6b 10 80 	movl   $0x80106b28,(%esp)
80106b79:	e8 2f 9c ff ff       	call   801007ad <consoleintr>
}
80106b7e:	c9                   	leave  
80106b7f:	c3                   	ret    
...
80106b82:	6a 00                	push   $0x0
  jmp alltraps
80106b84:	e9 43 f9 ff ff       	jmp    801064cc <alltraps>
...
80106b89:	6a 00                	push   $0x0
  pushl $1
80106b8b:	6a 01                	push   $0x1
  jmp alltraps
80106b8d:	e9 3a f9 ff ff       	jmp    801064cc <alltraps>
...
80106b92:	6a 00                	push   $0x0
  pushl $2
80106b94:	6a 02                	push   $0x2
  jmp alltraps
80106b96:	e9 31 f9 ff ff       	jmp    801064cc <alltraps>
...
80106b9b:	6a 00                	push   $0x0
  pushl $3
80106b9d:	6a 03                	push   $0x3
  jmp alltraps
80106b9f:	e9 28 f9 ff ff       	jmp    801064cc <alltraps>
...
80106ba4:	6a 00                	push   $0x0
  pushl $4
80106ba6:	6a 04                	push   $0x4
  jmp alltraps
80106ba8:	e9 1f f9 ff ff       	jmp    801064cc <alltraps>
...
80106bad:	6a 00                	push   $0x0
  pushl $5
80106baf:	6a 05                	push   $0x5
  jmp alltraps
80106bb1:	e9 16 f9 ff ff       	jmp    801064cc <alltraps>
...
80106bb8:	6a 06                	push   $0x6
  jmp alltraps
80106bba:	e9 0d f9 ff ff       	jmp    801064cc <alltraps>
...
80106bbf:	6a 00                	push   $0x0
  pushl $7
80106bc1:	6a 07                	push   $0x7
  jmp alltraps
80106bc3:	e9 04 f9 ff ff       	jmp    801064cc <alltraps>

80106bc8 <vector8>:
.globl vector8
vector8:
  pushl $8
80106bc8:	6a 08                	push   $0x8
  jmp alltraps
80106bca:	e9 fd f8 ff ff       	jmp    801064cc <alltraps>
...
80106bcf:	6a 00                	push   $0x0
  pushl $9
80106bd1:	6a 09                	push   $0x9
  jmp alltraps
80106bd3:	e9 f4 f8 ff ff       	jmp    801064cc <alltraps>

80106bd8 <vector10>:
.globl vector10
vector10:
  pushl $10
80106bd8:	6a 0a                	push   $0xa
  jmp alltraps
80106bda:	e9 ed f8 ff ff       	jmp    801064cc <alltraps>

80106bdf <vector11>:
.globl vector11
vector11:
  pushl $11
80106bdf:	6a 0b                	push   $0xb
  jmp alltraps
80106be1:	e9 e6 f8 ff ff       	jmp    801064cc <alltraps>
...
80106be6:	6a 0c                	push   $0xc
  jmp alltraps
80106be8:	e9 df f8 ff ff       	jmp    801064cc <alltraps>

80106bed <vector13>:
.globl vector13
vector13:
  pushl $13
80106bed:	6a 0d                	push   $0xd
  jmp alltraps
80106bef:	e9 d8 f8 ff ff       	jmp    801064cc <alltraps>

80106bf4 <vector14>:
.globl vector14
vector14:
  pushl $14
80106bf4:	6a 0e                	push   $0xe
  jmp alltraps
80106bf6:	e9 d1 f8 ff ff       	jmp    801064cc <alltraps>
...
80106bfb:	6a 00                	push   $0x0
  pushl $15
80106bfd:	6a 0f                	push   $0xf
  jmp alltraps
80106bff:	e9 c8 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c04:	6a 00                	push   $0x0
  pushl $16
80106c06:	6a 10                	push   $0x10
  jmp alltraps
80106c08:	e9 bf f8 ff ff       	jmp    801064cc <alltraps>

80106c0d <vector17>:
.globl vector17
vector17:
  pushl $17
80106c0d:	6a 11                	push   $0x11
  jmp alltraps
80106c0f:	e9 b8 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c14:	6a 00                	push   $0x0
  pushl $18
80106c16:	6a 12                	push   $0x12
  jmp alltraps
80106c18:	e9 af f8 ff ff       	jmp    801064cc <alltraps>
...
80106c1d:	6a 00                	push   $0x0
  pushl $19
80106c1f:	6a 13                	push   $0x13
  jmp alltraps
80106c21:	e9 a6 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $20
80106c28:	6a 14                	push   $0x14
  jmp alltraps
80106c2a:	e9 9d f8 ff ff       	jmp    801064cc <alltraps>
...
80106c2f:	6a 00                	push   $0x0
  pushl $21
80106c31:	6a 15                	push   $0x15
  jmp alltraps
80106c33:	e9 94 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c38:	6a 00                	push   $0x0
  pushl $22
80106c3a:	6a 16                	push   $0x16
  jmp alltraps
80106c3c:	e9 8b f8 ff ff       	jmp    801064cc <alltraps>
...
80106c41:	6a 00                	push   $0x0
  pushl $23
80106c43:	6a 17                	push   $0x17
  jmp alltraps
80106c45:	e9 82 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $24
80106c4c:	6a 18                	push   $0x18
  jmp alltraps
80106c4e:	e9 79 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c53:	6a 00                	push   $0x0
  pushl $25
80106c55:	6a 19                	push   $0x19
  jmp alltraps
80106c57:	e9 70 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c5c:	6a 00                	push   $0x0
  pushl $26
80106c5e:	6a 1a                	push   $0x1a
  jmp alltraps
80106c60:	e9 67 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c65:	6a 00                	push   $0x0
  pushl $27
80106c67:	6a 1b                	push   $0x1b
  jmp alltraps
80106c69:	e9 5e f8 ff ff       	jmp    801064cc <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $28
80106c70:	6a 1c                	push   $0x1c
  jmp alltraps
80106c72:	e9 55 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c77:	6a 00                	push   $0x0
  pushl $29
80106c79:	6a 1d                	push   $0x1d
  jmp alltraps
80106c7b:	e9 4c f8 ff ff       	jmp    801064cc <alltraps>
...
80106c80:	6a 00                	push   $0x0
  pushl $30
80106c82:	6a 1e                	push   $0x1e
  jmp alltraps
80106c84:	e9 43 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c89:	6a 00                	push   $0x0
  pushl $31
80106c8b:	6a 1f                	push   $0x1f
  jmp alltraps
80106c8d:	e9 3a f8 ff ff       	jmp    801064cc <alltraps>
...
80106c92:	6a 00                	push   $0x0
  pushl $32
80106c94:	6a 20                	push   $0x20
  jmp alltraps
80106c96:	e9 31 f8 ff ff       	jmp    801064cc <alltraps>
...
80106c9b:	6a 00                	push   $0x0
  pushl $33
80106c9d:	6a 21                	push   $0x21
  jmp alltraps
80106c9f:	e9 28 f8 ff ff       	jmp    801064cc <alltraps>
...
80106ca4:	6a 00                	push   $0x0
  pushl $34
80106ca6:	6a 22                	push   $0x22
  jmp alltraps
80106ca8:	e9 1f f8 ff ff       	jmp    801064cc <alltraps>
...
80106cad:	6a 00                	push   $0x0
  pushl $35
80106caf:	6a 23                	push   $0x23
  jmp alltraps
80106cb1:	e9 16 f8 ff ff       	jmp    801064cc <alltraps>
...
80106cb6:	6a 00                	push   $0x0
  pushl $36
80106cb8:	6a 24                	push   $0x24
  jmp alltraps
80106cba:	e9 0d f8 ff ff       	jmp    801064cc <alltraps>
...
80106cbf:	6a 00                	push   $0x0
  pushl $37
80106cc1:	6a 25                	push   $0x25
  jmp alltraps
80106cc3:	e9 04 f8 ff ff       	jmp    801064cc <alltraps>
...
80106cc8:	6a 00                	push   $0x0
  pushl $38
80106cca:	6a 26                	push   $0x26
  jmp alltraps
80106ccc:	e9 fb f7 ff ff       	jmp    801064cc <alltraps>
...
80106cd1:	6a 00                	push   $0x0
  pushl $39
80106cd3:	6a 27                	push   $0x27
  jmp alltraps
80106cd5:	e9 f2 f7 ff ff       	jmp    801064cc <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $40
80106cdc:	6a 28                	push   $0x28
  jmp alltraps
80106cde:	e9 e9 f7 ff ff       	jmp    801064cc <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $41
80106ce5:	6a 29                	push   $0x29
  jmp alltraps
80106ce7:	e9 e0 f7 ff ff       	jmp    801064cc <alltraps>
...
80106cec:	6a 00                	push   $0x0
  pushl $42
80106cee:	6a 2a                	push   $0x2a
  jmp alltraps
80106cf0:	e9 d7 f7 ff ff       	jmp    801064cc <alltraps>
...
80106cf5:	6a 00                	push   $0x0
  pushl $43
80106cf7:	6a 2b                	push   $0x2b
  jmp alltraps
80106cf9:	e9 ce f7 ff ff       	jmp    801064cc <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $44
80106d00:	6a 2c                	push   $0x2c
  jmp alltraps
80106d02:	e9 c5 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $45
80106d09:	6a 2d                	push   $0x2d
  jmp alltraps
80106d0b:	e9 bc f7 ff ff       	jmp    801064cc <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $46
80106d12:	6a 2e                	push   $0x2e
  jmp alltraps
80106d14:	e9 b3 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $47
80106d1b:	6a 2f                	push   $0x2f
  jmp alltraps
80106d1d:	e9 aa f7 ff ff       	jmp    801064cc <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $48
80106d24:	6a 30                	push   $0x30
  jmp alltraps
80106d26:	e9 a1 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $49
80106d2d:	6a 31                	push   $0x31
  jmp alltraps
80106d2f:	e9 98 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $50
80106d36:	6a 32                	push   $0x32
  jmp alltraps
80106d38:	e9 8f f7 ff ff       	jmp    801064cc <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $51
80106d3f:	6a 33                	push   $0x33
  jmp alltraps
80106d41:	e9 86 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $52
80106d48:	6a 34                	push   $0x34
  jmp alltraps
80106d4a:	e9 7d f7 ff ff       	jmp    801064cc <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $53
80106d51:	6a 35                	push   $0x35
  jmp alltraps
80106d53:	e9 74 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $54
80106d5a:	6a 36                	push   $0x36
  jmp alltraps
80106d5c:	e9 6b f7 ff ff       	jmp    801064cc <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $55
80106d63:	6a 37                	push   $0x37
  jmp alltraps
80106d65:	e9 62 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $56
80106d6c:	6a 38                	push   $0x38
  jmp alltraps
80106d6e:	e9 59 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $57
80106d75:	6a 39                	push   $0x39
  jmp alltraps
80106d77:	e9 50 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $58
80106d7e:	6a 3a                	push   $0x3a
  jmp alltraps
80106d80:	e9 47 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $59
80106d87:	6a 3b                	push   $0x3b
  jmp alltraps
80106d89:	e9 3e f7 ff ff       	jmp    801064cc <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $60
80106d90:	6a 3c                	push   $0x3c
  jmp alltraps
80106d92:	e9 35 f7 ff ff       	jmp    801064cc <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $61
80106d99:	6a 3d                	push   $0x3d
  jmp alltraps
80106d9b:	e9 2c f7 ff ff       	jmp    801064cc <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $62
80106da2:	6a 3e                	push   $0x3e
  jmp alltraps
80106da4:	e9 23 f7 ff ff       	jmp    801064cc <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $63
80106dab:	6a 3f                	push   $0x3f
  jmp alltraps
80106dad:	e9 1a f7 ff ff       	jmp    801064cc <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $64
80106db4:	6a 40                	push   $0x40
  jmp alltraps
80106db6:	e9 11 f7 ff ff       	jmp    801064cc <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $65
80106dbd:	6a 41                	push   $0x41
  jmp alltraps
80106dbf:	e9 08 f7 ff ff       	jmp    801064cc <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $66
80106dc6:	6a 42                	push   $0x42
  jmp alltraps
80106dc8:	e9 ff f6 ff ff       	jmp    801064cc <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $67
80106dcf:	6a 43                	push   $0x43
  jmp alltraps
80106dd1:	e9 f6 f6 ff ff       	jmp    801064cc <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $68
80106dd8:	6a 44                	push   $0x44
  jmp alltraps
80106dda:	e9 ed f6 ff ff       	jmp    801064cc <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $69
80106de1:	6a 45                	push   $0x45
  jmp alltraps
80106de3:	e9 e4 f6 ff ff       	jmp    801064cc <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $70
80106dea:	6a 46                	push   $0x46
  jmp alltraps
80106dec:	e9 db f6 ff ff       	jmp    801064cc <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $71
80106df3:	6a 47                	push   $0x47
  jmp alltraps
80106df5:	e9 d2 f6 ff ff       	jmp    801064cc <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $72
80106dfc:	6a 48                	push   $0x48
  jmp alltraps
80106dfe:	e9 c9 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $73
80106e05:	6a 49                	push   $0x49
  jmp alltraps
80106e07:	e9 c0 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $74
80106e0e:	6a 4a                	push   $0x4a
  jmp alltraps
80106e10:	e9 b7 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $75
80106e17:	6a 4b                	push   $0x4b
  jmp alltraps
80106e19:	e9 ae f6 ff ff       	jmp    801064cc <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $76
80106e20:	6a 4c                	push   $0x4c
  jmp alltraps
80106e22:	e9 a5 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $77
80106e29:	6a 4d                	push   $0x4d
  jmp alltraps
80106e2b:	e9 9c f6 ff ff       	jmp    801064cc <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $78
80106e32:	6a 4e                	push   $0x4e
  jmp alltraps
80106e34:	e9 93 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $79
80106e3b:	6a 4f                	push   $0x4f
  jmp alltraps
80106e3d:	e9 8a f6 ff ff       	jmp    801064cc <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $80
80106e44:	6a 50                	push   $0x50
  jmp alltraps
80106e46:	e9 81 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $81
80106e4d:	6a 51                	push   $0x51
  jmp alltraps
80106e4f:	e9 78 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $82
80106e56:	6a 52                	push   $0x52
  jmp alltraps
80106e58:	e9 6f f6 ff ff       	jmp    801064cc <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $83
80106e5f:	6a 53                	push   $0x53
  jmp alltraps
80106e61:	e9 66 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $84
80106e68:	6a 54                	push   $0x54
  jmp alltraps
80106e6a:	e9 5d f6 ff ff       	jmp    801064cc <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $85
80106e71:	6a 55                	push   $0x55
  jmp alltraps
80106e73:	e9 54 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $86
80106e7a:	6a 56                	push   $0x56
  jmp alltraps
80106e7c:	e9 4b f6 ff ff       	jmp    801064cc <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $87
80106e83:	6a 57                	push   $0x57
  jmp alltraps
80106e85:	e9 42 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $88
80106e8c:	6a 58                	push   $0x58
  jmp alltraps
80106e8e:	e9 39 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $89
80106e95:	6a 59                	push   $0x59
  jmp alltraps
80106e97:	e9 30 f6 ff ff       	jmp    801064cc <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $90
80106e9e:	6a 5a                	push   $0x5a
  jmp alltraps
80106ea0:	e9 27 f6 ff ff       	jmp    801064cc <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $91
80106ea7:	6a 5b                	push   $0x5b
  jmp alltraps
80106ea9:	e9 1e f6 ff ff       	jmp    801064cc <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $92
80106eb0:	6a 5c                	push   $0x5c
  jmp alltraps
80106eb2:	e9 15 f6 ff ff       	jmp    801064cc <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $93
80106eb9:	6a 5d                	push   $0x5d
  jmp alltraps
80106ebb:	e9 0c f6 ff ff       	jmp    801064cc <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $94
80106ec2:	6a 5e                	push   $0x5e
  jmp alltraps
80106ec4:	e9 03 f6 ff ff       	jmp    801064cc <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $95
80106ecb:	6a 5f                	push   $0x5f
  jmp alltraps
80106ecd:	e9 fa f5 ff ff       	jmp    801064cc <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $96
80106ed4:	6a 60                	push   $0x60
  jmp alltraps
80106ed6:	e9 f1 f5 ff ff       	jmp    801064cc <alltraps>
...
80106edb:	6a 00                	push   $0x0
  pushl $97
80106edd:	6a 61                	push   $0x61
  jmp alltraps
80106edf:	e9 e8 f5 ff ff       	jmp    801064cc <alltraps>
...
80106ee4:	6a 00                	push   $0x0
  pushl $98
80106ee6:	6a 62                	push   $0x62
  jmp alltraps
80106ee8:	e9 df f5 ff ff       	jmp    801064cc <alltraps>
...
80106eed:	6a 00                	push   $0x0
  pushl $99
80106eef:	6a 63                	push   $0x63
  jmp alltraps
80106ef1:	e9 d6 f5 ff ff       	jmp    801064cc <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $100
80106ef8:	6a 64                	push   $0x64
  jmp alltraps
80106efa:	e9 cd f5 ff ff       	jmp    801064cc <alltraps>
...
80106eff:	6a 00                	push   $0x0
  pushl $101
80106f01:	6a 65                	push   $0x65
  jmp alltraps
80106f03:	e9 c4 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f08:	6a 00                	push   $0x0
  pushl $102
80106f0a:	6a 66                	push   $0x66
  jmp alltraps
80106f0c:	e9 bb f5 ff ff       	jmp    801064cc <alltraps>
...
80106f11:	6a 00                	push   $0x0
  pushl $103
80106f13:	6a 67                	push   $0x67
  jmp alltraps
80106f15:	e9 b2 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $104
80106f1c:	6a 68                	push   $0x68
  jmp alltraps
80106f1e:	e9 a9 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f23:	6a 00                	push   $0x0
  pushl $105
80106f25:	6a 69                	push   $0x69
  jmp alltraps
80106f27:	e9 a0 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f2c:	6a 00                	push   $0x0
  pushl $106
80106f2e:	6a 6a                	push   $0x6a
  jmp alltraps
80106f30:	e9 97 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f35:	6a 00                	push   $0x0
  pushl $107
80106f37:	6a 6b                	push   $0x6b
  jmp alltraps
80106f39:	e9 8e f5 ff ff       	jmp    801064cc <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $108
80106f40:	6a 6c                	push   $0x6c
  jmp alltraps
80106f42:	e9 85 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f47:	6a 00                	push   $0x0
  pushl $109
80106f49:	6a 6d                	push   $0x6d
  jmp alltraps
80106f4b:	e9 7c f5 ff ff       	jmp    801064cc <alltraps>
...
80106f50:	6a 00                	push   $0x0
  pushl $110
80106f52:	6a 6e                	push   $0x6e
  jmp alltraps
80106f54:	e9 73 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f59:	6a 00                	push   $0x0
  pushl $111
80106f5b:	6a 6f                	push   $0x6f
  jmp alltraps
80106f5d:	e9 6a f5 ff ff       	jmp    801064cc <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $112
80106f64:	6a 70                	push   $0x70
  jmp alltraps
80106f66:	e9 61 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f6b:	6a 00                	push   $0x0
  pushl $113
80106f6d:	6a 71                	push   $0x71
  jmp alltraps
80106f6f:	e9 58 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f74:	6a 00                	push   $0x0
  pushl $114
80106f76:	6a 72                	push   $0x72
  jmp alltraps
80106f78:	e9 4f f5 ff ff       	jmp    801064cc <alltraps>
...
80106f7d:	6a 00                	push   $0x0
  pushl $115
80106f7f:	6a 73                	push   $0x73
  jmp alltraps
80106f81:	e9 46 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $116
80106f88:	6a 74                	push   $0x74
  jmp alltraps
80106f8a:	e9 3d f5 ff ff       	jmp    801064cc <alltraps>
...
80106f8f:	6a 00                	push   $0x0
  pushl $117
80106f91:	6a 75                	push   $0x75
  jmp alltraps
80106f93:	e9 34 f5 ff ff       	jmp    801064cc <alltraps>
...
80106f98:	6a 00                	push   $0x0
  pushl $118
80106f9a:	6a 76                	push   $0x76
  jmp alltraps
80106f9c:	e9 2b f5 ff ff       	jmp    801064cc <alltraps>
...
80106fa1:	6a 00                	push   $0x0
  pushl $119
80106fa3:	6a 77                	push   $0x77
  jmp alltraps
80106fa5:	e9 22 f5 ff ff       	jmp    801064cc <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $120
80106fac:	6a 78                	push   $0x78
  jmp alltraps
80106fae:	e9 19 f5 ff ff       	jmp    801064cc <alltraps>
...
80106fb3:	6a 00                	push   $0x0
  pushl $121
80106fb5:	6a 79                	push   $0x79
  jmp alltraps
80106fb7:	e9 10 f5 ff ff       	jmp    801064cc <alltraps>
...
80106fbc:	6a 00                	push   $0x0
  pushl $122
80106fbe:	6a 7a                	push   $0x7a
  jmp alltraps
80106fc0:	e9 07 f5 ff ff       	jmp    801064cc <alltraps>
...
80106fc5:	6a 00                	push   $0x0
  pushl $123
80106fc7:	6a 7b                	push   $0x7b
  jmp alltraps
80106fc9:	e9 fe f4 ff ff       	jmp    801064cc <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $124
80106fd0:	6a 7c                	push   $0x7c
  jmp alltraps
80106fd2:	e9 f5 f4 ff ff       	jmp    801064cc <alltraps>
...
80106fd7:	6a 00                	push   $0x0
  pushl $125
80106fd9:	6a 7d                	push   $0x7d
  jmp alltraps
80106fdb:	e9 ec f4 ff ff       	jmp    801064cc <alltraps>
...
80106fe0:	6a 00                	push   $0x0
  pushl $126
80106fe2:	6a 7e                	push   $0x7e
  jmp alltraps
80106fe4:	e9 e3 f4 ff ff       	jmp    801064cc <alltraps>
...
80106fe9:	6a 00                	push   $0x0
  pushl $127
80106feb:	6a 7f                	push   $0x7f
  jmp alltraps
80106fed:	e9 da f4 ff ff       	jmp    801064cc <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $128
80106ff4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106ff9:	e9 ce f4 ff ff       	jmp    801064cc <alltraps>
...
80106ffe:	6a 00                	push   $0x0
  pushl $129
80107000:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107005:	e9 c2 f4 ff ff       	jmp    801064cc <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $130
8010700c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107011:	e9 b6 f4 ff ff       	jmp    801064cc <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $131
80107018:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010701d:	e9 aa f4 ff ff       	jmp    801064cc <alltraps>
...
80107022:	6a 00                	push   $0x0
  pushl $132
80107024:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107029:	e9 9e f4 ff ff       	jmp    801064cc <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $133
80107030:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107035:	e9 92 f4 ff ff       	jmp    801064cc <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $134
8010703c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107041:	e9 86 f4 ff ff       	jmp    801064cc <alltraps>
...
80107046:	6a 00                	push   $0x0
  pushl $135
80107048:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010704d:	e9 7a f4 ff ff       	jmp    801064cc <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $136
80107054:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107059:	e9 6e f4 ff ff       	jmp    801064cc <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $137
80107060:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107065:	e9 62 f4 ff ff       	jmp    801064cc <alltraps>
...
8010706a:	6a 00                	push   $0x0
  pushl $138
8010706c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107071:	e9 56 f4 ff ff       	jmp    801064cc <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $139
80107078:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010707d:	e9 4a f4 ff ff       	jmp    801064cc <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $140
80107084:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107089:	e9 3e f4 ff ff       	jmp    801064cc <alltraps>
...
8010708e:	6a 00                	push   $0x0
  pushl $141
80107090:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107095:	e9 32 f4 ff ff       	jmp    801064cc <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $142
8010709c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801070a1:	e9 26 f4 ff ff       	jmp    801064cc <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $143
801070a8:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801070ad:	e9 1a f4 ff ff       	jmp    801064cc <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $144
801070b4:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801070b9:	e9 0e f4 ff ff       	jmp    801064cc <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $145
801070c0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801070c5:	e9 02 f4 ff ff       	jmp    801064cc <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $146
801070cc:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801070d1:	e9 f6 f3 ff ff       	jmp    801064cc <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $147
801070d8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801070dd:	e9 ea f3 ff ff       	jmp    801064cc <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $148
801070e4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801070e9:	e9 de f3 ff ff       	jmp    801064cc <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $149
801070f0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801070f5:	e9 d2 f3 ff ff       	jmp    801064cc <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $150
801070fc:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107101:	e9 c6 f3 ff ff       	jmp    801064cc <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $151
80107108:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010710d:	e9 ba f3 ff ff       	jmp    801064cc <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $152
80107114:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107119:	e9 ae f3 ff ff       	jmp    801064cc <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $153
80107120:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107125:	e9 a2 f3 ff ff       	jmp    801064cc <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $154
8010712c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107131:	e9 96 f3 ff ff       	jmp    801064cc <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $155
80107138:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010713d:	e9 8a f3 ff ff       	jmp    801064cc <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $156
80107144:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107149:	e9 7e f3 ff ff       	jmp    801064cc <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $157
80107150:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107155:	e9 72 f3 ff ff       	jmp    801064cc <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $158
8010715c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107161:	e9 66 f3 ff ff       	jmp    801064cc <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $159
80107168:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010716d:	e9 5a f3 ff ff       	jmp    801064cc <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $160
80107174:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107179:	e9 4e f3 ff ff       	jmp    801064cc <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $161
80107180:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107185:	e9 42 f3 ff ff       	jmp    801064cc <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $162
8010718c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107191:	e9 36 f3 ff ff       	jmp    801064cc <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $163
80107198:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010719d:	e9 2a f3 ff ff       	jmp    801064cc <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $164
801071a4:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801071a9:	e9 1e f3 ff ff       	jmp    801064cc <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $165
801071b0:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801071b5:	e9 12 f3 ff ff       	jmp    801064cc <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $166
801071bc:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801071c1:	e9 06 f3 ff ff       	jmp    801064cc <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $167
801071c8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801071cd:	e9 fa f2 ff ff       	jmp    801064cc <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $168
801071d4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801071d9:	e9 ee f2 ff ff       	jmp    801064cc <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $169
801071e0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801071e5:	e9 e2 f2 ff ff       	jmp    801064cc <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $170
801071ec:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801071f1:	e9 d6 f2 ff ff       	jmp    801064cc <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $171
801071f8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801071fd:	e9 ca f2 ff ff       	jmp    801064cc <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $172
80107204:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107209:	e9 be f2 ff ff       	jmp    801064cc <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $173
80107210:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107215:	e9 b2 f2 ff ff       	jmp    801064cc <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $174
8010721c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107221:	e9 a6 f2 ff ff       	jmp    801064cc <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $175
80107228:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010722d:	e9 9a f2 ff ff       	jmp    801064cc <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $176
80107234:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107239:	e9 8e f2 ff ff       	jmp    801064cc <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $177
80107240:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107245:	e9 82 f2 ff ff       	jmp    801064cc <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $178
8010724c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107251:	e9 76 f2 ff ff       	jmp    801064cc <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $179
80107258:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010725d:	e9 6a f2 ff ff       	jmp    801064cc <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $180
80107264:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107269:	e9 5e f2 ff ff       	jmp    801064cc <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $181
80107270:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107275:	e9 52 f2 ff ff       	jmp    801064cc <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $182
8010727c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107281:	e9 46 f2 ff ff       	jmp    801064cc <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $183
80107288:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010728d:	e9 3a f2 ff ff       	jmp    801064cc <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $184
80107294:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107299:	e9 2e f2 ff ff       	jmp    801064cc <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $185
801072a0:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801072a5:	e9 22 f2 ff ff       	jmp    801064cc <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $186
801072ac:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801072b1:	e9 16 f2 ff ff       	jmp    801064cc <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $187
801072b8:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801072bd:	e9 0a f2 ff ff       	jmp    801064cc <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $188
801072c4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801072c9:	e9 fe f1 ff ff       	jmp    801064cc <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $189
801072d0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801072d5:	e9 f2 f1 ff ff       	jmp    801064cc <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $190
801072dc:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801072e1:	e9 e6 f1 ff ff       	jmp    801064cc <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $191
801072e8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801072ed:	e9 da f1 ff ff       	jmp    801064cc <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $192
801072f4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801072f9:	e9 ce f1 ff ff       	jmp    801064cc <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $193
80107300:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107305:	e9 c2 f1 ff ff       	jmp    801064cc <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $194
8010730c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107311:	e9 b6 f1 ff ff       	jmp    801064cc <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $195
80107318:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010731d:	e9 aa f1 ff ff       	jmp    801064cc <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $196
80107324:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107329:	e9 9e f1 ff ff       	jmp    801064cc <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $197
80107330:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107335:	e9 92 f1 ff ff       	jmp    801064cc <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $198
8010733c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107341:	e9 86 f1 ff ff       	jmp    801064cc <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $199
80107348:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010734d:	e9 7a f1 ff ff       	jmp    801064cc <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $200
80107354:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107359:	e9 6e f1 ff ff       	jmp    801064cc <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $201
80107360:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107365:	e9 62 f1 ff ff       	jmp    801064cc <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $202
8010736c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107371:	e9 56 f1 ff ff       	jmp    801064cc <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $203
80107378:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010737d:	e9 4a f1 ff ff       	jmp    801064cc <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $204
80107384:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107389:	e9 3e f1 ff ff       	jmp    801064cc <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $205
80107390:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107395:	e9 32 f1 ff ff       	jmp    801064cc <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $206
8010739c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801073a1:	e9 26 f1 ff ff       	jmp    801064cc <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $207
801073a8:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801073ad:	e9 1a f1 ff ff       	jmp    801064cc <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $208
801073b4:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801073b9:	e9 0e f1 ff ff       	jmp    801064cc <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $209
801073c0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801073c5:	e9 02 f1 ff ff       	jmp    801064cc <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $210
801073cc:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801073d1:	e9 f6 f0 ff ff       	jmp    801064cc <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $211
801073d8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801073dd:	e9 ea f0 ff ff       	jmp    801064cc <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $212
801073e4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801073e9:	e9 de f0 ff ff       	jmp    801064cc <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $213
801073f0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801073f5:	e9 d2 f0 ff ff       	jmp    801064cc <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $214
801073fc:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107401:	e9 c6 f0 ff ff       	jmp    801064cc <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $215
80107408:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010740d:	e9 ba f0 ff ff       	jmp    801064cc <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $216
80107414:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107419:	e9 ae f0 ff ff       	jmp    801064cc <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $217
80107420:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107425:	e9 a2 f0 ff ff       	jmp    801064cc <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $218
8010742c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107431:	e9 96 f0 ff ff       	jmp    801064cc <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $219
80107438:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010743d:	e9 8a f0 ff ff       	jmp    801064cc <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $220
80107444:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107449:	e9 7e f0 ff ff       	jmp    801064cc <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $221
80107450:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107455:	e9 72 f0 ff ff       	jmp    801064cc <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $222
8010745c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107461:	e9 66 f0 ff ff       	jmp    801064cc <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $223
80107468:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010746d:	e9 5a f0 ff ff       	jmp    801064cc <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $224
80107474:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107479:	e9 4e f0 ff ff       	jmp    801064cc <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $225
80107480:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107485:	e9 42 f0 ff ff       	jmp    801064cc <alltraps>
...
8010748a:	6a 00                	push   $0x0
  pushl $226
8010748c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107491:	e9 36 f0 ff ff       	jmp    801064cc <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $227
80107498:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010749d:	e9 2a f0 ff ff       	jmp    801064cc <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $228
801074a4:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801074a9:	e9 1e f0 ff ff       	jmp    801064cc <alltraps>
...
801074ae:	6a 00                	push   $0x0
  pushl $229
801074b0:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801074b5:	e9 12 f0 ff ff       	jmp    801064cc <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $230
801074bc:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801074c1:	e9 06 f0 ff ff       	jmp    801064cc <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $231
801074c8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801074cd:	e9 fa ef ff ff       	jmp    801064cc <alltraps>
...
801074d2:	6a 00                	push   $0x0
  pushl $232
801074d4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801074d9:	e9 ee ef ff ff       	jmp    801064cc <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $233
801074e0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801074e5:	e9 e2 ef ff ff       	jmp    801064cc <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $234
801074ec:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801074f1:	e9 d6 ef ff ff       	jmp    801064cc <alltraps>
...
801074f6:	6a 00                	push   $0x0
  pushl $235
801074f8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801074fd:	e9 ca ef ff ff       	jmp    801064cc <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $236
80107504:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107509:	e9 be ef ff ff       	jmp    801064cc <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $237
80107510:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107515:	e9 b2 ef ff ff       	jmp    801064cc <alltraps>
...
8010751a:	6a 00                	push   $0x0
  pushl $238
8010751c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107521:	e9 a6 ef ff ff       	jmp    801064cc <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $239
80107528:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010752d:	e9 9a ef ff ff       	jmp    801064cc <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $240
80107534:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107539:	e9 8e ef ff ff       	jmp    801064cc <alltraps>
...
8010753e:	6a 00                	push   $0x0
  pushl $241
80107540:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107545:	e9 82 ef ff ff       	jmp    801064cc <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $242
8010754c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107551:	e9 76 ef ff ff       	jmp    801064cc <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $243
80107558:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010755d:	e9 6a ef ff ff       	jmp    801064cc <alltraps>
...
80107562:	6a 00                	push   $0x0
  pushl $244
80107564:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107569:	e9 5e ef ff ff       	jmp    801064cc <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $245
80107570:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107575:	e9 52 ef ff ff       	jmp    801064cc <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $246
8010757c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107581:	e9 46 ef ff ff       	jmp    801064cc <alltraps>
...
80107586:	6a 00                	push   $0x0
  pushl $247
80107588:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010758d:	e9 3a ef ff ff       	jmp    801064cc <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $248
80107594:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107599:	e9 2e ef ff ff       	jmp    801064cc <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $249
801075a0:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801075a5:	e9 22 ef ff ff       	jmp    801064cc <alltraps>
...
801075aa:	6a 00                	push   $0x0
  pushl $250
801075ac:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801075b1:	e9 16 ef ff ff       	jmp    801064cc <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $251
801075b8:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801075bd:	e9 0a ef ff ff       	jmp    801064cc <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $252
801075c4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801075c9:	e9 fe ee ff ff       	jmp    801064cc <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $253
801075d0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801075d5:	e9 f2 ee ff ff       	jmp    801064cc <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $254
801075dc:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801075e1:	e9 e6 ee ff ff       	jmp    801064cc <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $255
801075e8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801075ed:	e9 da ee ff ff       	jmp    801064cc <alltraps>
	...
...
80107671:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107674:	e8 14 b8 ff ff       	call   80102e8d <cpunum>
80107679:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010767f:	05 20 f9 10 80       	add    $0x8010f920,%eax
...
80107aef:	c1 e0 02             	shl    $0x2,%eax
80107af2:	03 45 08             	add    0x8(%ebp),%eax
...
80107b00:	84 c0                	test   %al,%al
80107b02:	74 17                	je     80107b1b <walkpgdir+0x38>
...
80107b11:	e8 4a fb ff ff       	call   80107660 <p2v>
80107b16:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b19:	eb 4b                	jmp    80107b66 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107b1b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107b1f:	74 0e                	je     80107b2f <walkpgdir+0x4c>
80107b21:	e8 d9 af ff ff       	call   80102aff <kalloc>
80107b26:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b29:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107b2d:	75 07                	jne    80107b36 <walkpgdir+0x53>
      return 0;
80107b2f:	b8 00 00 00 00       	mov    $0x0,%eax
80107b34:	eb 41                	jmp    80107b77 <walkpgdir+0x94>
...
80107b4c:	e8 15 d5 ff ff       	call   80105066 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107b51:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b54:	89 04 24             	mov    %eax,(%esp)
80107b57:	e8 f7 fa ff ff       	call   80107653 <v2p>
80107b5c:	89 c2                	mov    %eax,%edx
80107b5e:	83 ca 07             	or     $0x7,%edx
80107b61:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b64:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107b66:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b69:	c1 e8 0c             	shr    $0xc,%eax
80107b6c:	25 ff 03 00 00       	and    $0x3ff,%eax
80107b71:	c1 e0 02             	shl    $0x2,%eax
80107b74:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107b77:	c9                   	leave  
80107b78:	c3                   	ret    
...
80107b7c:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107b8d:	03 45 10             	add    0x10(%ebp),%eax
80107b90:	83 e8 01             	sub    $0x1,%eax
80107b93:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b98:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107b9b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107ba2:	00 
80107ba3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107baa:	8b 45 08             	mov    0x8(%ebp),%eax
80107bad:	89 04 24             	mov    %eax,(%esp)
80107bb0:	e8 2e ff ff ff       	call   80107ae3 <walkpgdir>
80107bb5:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107bb8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107bbc:	75 07                	jne    80107bc5 <mappages+0x4c>
      return -1;
80107bbe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107bc3:	eb 46                	jmp    80107c0b <mappages+0x92>
    if(*pte & PTE_P)
80107bc5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107bc8:	8b 00                	mov    (%eax),%eax
80107bca:	83 e0 01             	and    $0x1,%eax
80107bcd:	84 c0                	test   %al,%al
80107bcf:	74 0c                	je     80107bdd <mappages+0x64>
      panic("remap");
80107bd1:	c7 04 24 a4 8a 10 80 	movl   $0x80108aa4,(%esp)
80107bd8:	e8 60 89 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107bdd:	8b 45 18             	mov    0x18(%ebp),%eax
80107be0:	0b 45 14             	or     0x14(%ebp),%eax
80107be3:	89 c2                	mov    %eax,%edx
80107be5:	83 ca 01             	or     $0x1,%edx
80107be8:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107beb:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bf0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107bf3:	74 10                	je     80107c05 <mappages+0x8c>
      break;
    a += PGSIZE;
80107bf5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107bfc:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107c03:	eb 96                	jmp    80107b9b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107c11:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107c14:	e8 e6 ae ff ff       	call   80102aff <kalloc>
80107c19:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107c1c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107c20:	75 0a                	jne    80107c2c <setupkvm+0x1f>
    return 0;
80107c22:	b8 00 00 00 00       	mov    $0x0,%eax
80107c27:	e9 98 00 00 00       	jmp    80107cc4 <setupkvm+0xb7>
...
80107c42:	e8 1f d4 ff ff       	call   80105066 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107c47:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107c4e:	e8 0d fa ff ff       	call   80107660 <p2v>
80107c53:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107c58:	76 0c                	jbe    80107c66 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107c5a:	c7 04 24 aa 8a 10 80 	movl   $0x80108aaa,(%esp)
80107c61:	e8 d7 88 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c66:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107c6d:	eb 49                	jmp    80107cb8 <setupkvm+0xab>
...
80107c6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107c72:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107c75:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107c78:	8b 50 04             	mov    0x4(%eax),%edx
80107c7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c7e:	8b 58 08             	mov    0x8(%eax),%ebx
80107c81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c84:	8b 40 04             	mov    0x4(%eax),%eax
80107c87:	29 c3                	sub    %eax,%ebx
80107c89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c8c:	8b 00                	mov    (%eax),%eax
80107c8e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107c92:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107c96:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107c9a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c9e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ca1:	89 04 24             	mov    %eax,(%esp)
80107ca4:	e8 d0 fe ff ff       	call   80107b79 <mappages>
80107ca9:	85 c0                	test   %eax,%eax
80107cab:	79 07                	jns    80107cb4 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107cad:	b8 00 00 00 00       	mov    $0x0,%eax
80107cb2:	eb 10                	jmp    80107cc4 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107cb4:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107cb8:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107cbf:	72 ae                	jb     80107c6f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
80107cc1:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107cc4:	83 c4 34             	add    $0x34,%esp
80107cc7:	5b                   	pop    %ebx
80107cc8:	5d                   	pop    %ebp
80107cc9:	c3                   	ret    
...
80107ccd:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107cd0:	e8 38 ff ff ff       	call   80107c0d <setupkvm>
80107cd5:	a3 18 2a 11 80       	mov    %eax,0x80112a18
  switchkvm();
80107cda:	e8 02 00 00 00       	call   80107ce1 <switchkvm>
}
80107cdf:	c9                   	leave  
80107ce0:	c3                   	ret    
...
80107ce4:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
80107ce7:	a1 18 2a 11 80       	mov    0x80112a18,%eax
80107cec:	89 04 24             	mov    %eax,(%esp)
80107cef:	e8 5f f9 ff ff       	call   80107653 <v2p>
80107cf4:	89 04 24             	mov    %eax,(%esp)
80107cf7:	e8 4c f9 ff ff       	call   80107648 <lcr3>
}
80107cfc:	c9                   	leave  
80107cfd:	c3                   	ret    
...
80107d01:	53                   	push   %ebx
80107d02:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107d05:	e8 55 d2 ff ff       	call   80104f5f <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107d0a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d10:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d17:	83 c2 08             	add    $0x8,%edx
80107d1a:	89 d3                	mov    %edx,%ebx
80107d1c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d23:	83 c2 08             	add    $0x8,%edx
80107d26:	c1 ea 10             	shr    $0x10,%edx
80107d29:	89 d1                	mov    %edx,%ecx
80107d2b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d32:	83 c2 08             	add    $0x8,%edx
80107d35:	c1 ea 18             	shr    $0x18,%edx
80107d38:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107d3f:	67 00 
80107d41:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107d48:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107d4e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d55:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d58:	83 c9 09             	or     $0x9,%ecx
80107d5b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d61:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d68:	83 c9 10             	or     $0x10,%ecx
80107d6b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d71:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d78:	83 e1 9f             	and    $0xffffff9f,%ecx
80107d7b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d81:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d88:	83 c9 80             	or     $0xffffff80,%ecx
80107d8b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d91:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d98:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d9b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107da1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107da8:	83 e1 ef             	and    $0xffffffef,%ecx
80107dab:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107db1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107db8:	83 e1 df             	and    $0xffffffdf,%ecx
80107dbb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107dc1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107dc8:	83 c9 40             	or     $0x40,%ecx
80107dcb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107dd1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107dd8:	83 e1 7f             	and    $0x7f,%ecx
80107ddb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107de1:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107de7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ded:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107df4:	83 e2 ef             	and    $0xffffffef,%edx
80107df7:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107dfd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e03:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107e09:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e0f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107e16:	8b 52 08             	mov    0x8(%edx),%edx
80107e19:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107e1f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107e22:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107e29:	e8 ef f7 ff ff       	call   8010761d <ltr>
  if(p->pgdir == 0)
80107e2e:	8b 45 08             	mov    0x8(%ebp),%eax
80107e31:	8b 40 04             	mov    0x4(%eax),%eax
80107e34:	85 c0                	test   %eax,%eax
80107e36:	75 0c                	jne    80107e44 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107e38:	c7 04 24 bb 8a 10 80 	movl   $0x80108abb,(%esp)
80107e3f:	e8 f9 86 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107e44:	8b 45 08             	mov    0x8(%ebp),%eax
80107e47:	8b 40 04             	mov    0x4(%eax),%eax
80107e4a:	89 04 24             	mov    %eax,(%esp)
80107e4d:	e8 01 f8 ff ff       	call   80107653 <v2p>
80107e52:	89 04 24             	mov    %eax,(%esp)
80107e55:	e8 ee f7 ff ff       	call   80107648 <lcr3>
  popcli();
80107e5a:	e8 48 d1 ff ff       	call   80104fa7 <popcli>
}
80107e5f:	83 c4 14             	add    $0x14,%esp
80107e62:	5b                   	pop    %ebx
80107e63:	5d                   	pop    %ebp
80107e64:	c3                   	ret    
...
80107e68:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107e6b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107e72:	76 0c                	jbe    80107e80 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107e74:	c7 04 24 cf 8a 10 80 	movl   $0x80108acf,(%esp)
80107e7b:	e8 bd 86 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107e80:	e8 7a ac ff ff       	call   80102aff <kalloc>
...
80107e9e:	e8 c3 d1 ff ff       	call   80105066 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107ea3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea6:	89 04 24             	mov    %eax,(%esp)
80107ea9:	e8 a5 f7 ff ff       	call   80107653 <v2p>
80107eae:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107eb5:	00 
80107eb6:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107eba:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ec1:	00 
80107ec2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107ec9:	00 
80107eca:	8b 45 08             	mov    0x8(%ebp),%eax
80107ecd:	89 04 24             	mov    %eax,(%esp)
80107ed0:	e8 a4 fc ff ff       	call   80107b79 <mappages>
  memmove(mem, init, sz);
...
80107ee9:	e8 4b d2 ff ff       	call   80105139 <memmove>
}
80107eee:	c9                   	leave  
80107eef:	c3                   	ret    
...
80107ef4:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107f01:	74 0c                	je     80107f0f <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107f03:	c7 04 24 ec 8a 10 80 	movl   $0x80108aec,(%esp)
80107f0a:	e8 2e 86 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107f0f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f16:	e9 ad 00 00 00       	jmp    80107fc8 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107f1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f1e:	8b 55 0c             	mov    0xc(%ebp),%edx
80107f21:	01 d0                	add    %edx,%eax
80107f23:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f2a:	00 
80107f2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f2f:	8b 45 08             	mov    0x8(%ebp),%eax
80107f32:	89 04 24             	mov    %eax,(%esp)
80107f35:	e8 a9 fb ff ff       	call   80107ae3 <walkpgdir>
80107f3a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f3d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f41:	75 0c                	jne    80107f4f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107f43:	c7 04 24 0f 8b 10 80 	movl   $0x80108b0f,(%esp)
80107f4a:	e8 ee 85 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80107f62:	89 d1                	mov    %edx,%ecx
80107f64:	29 c1                	sub    %eax,%ecx
80107f66:	89 c8                	mov    %ecx,%eax
80107f68:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107f6d:	77 11                	ja     80107f80 <loaduvm+0x90>
      n = sz - i;
80107f6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f72:	8b 55 18             	mov    0x18(%ebp),%edx
80107f75:	89 d1                	mov    %edx,%ecx
80107f77:	29 c1                	sub    %eax,%ecx
80107f79:	89 c8                	mov    %ecx,%eax
80107f7b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f7e:	eb 07                	jmp    80107f87 <loaduvm+0x97>
    else
      n = PGSIZE;
80107f80:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107f87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8a:	8b 55 14             	mov    0x14(%ebp),%edx
80107f8d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107f90:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f93:	89 04 24             	mov    %eax,(%esp)
80107f96:	e8 c5 f6 ff ff       	call   80107660 <p2v>
80107f9b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107f9e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fa2:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107fa6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107faa:	8b 45 10             	mov    0x10(%ebp),%eax
80107fad:	89 04 24             	mov    %eax,(%esp)
80107fb0:	e8 a9 9d ff ff       	call   80101d5e <readi>
80107fb5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107fb8:	74 07                	je     80107fc1 <loaduvm+0xd1>
      return -1;
80107fba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107fbf:	eb 18                	jmp    80107fd9 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107fc1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107fc8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fcb:	3b 45 18             	cmp    0x18(%ebp),%eax
80107fce:	0f 82 47 ff ff ff    	jb     80107f1b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107fd9:	83 c4 24             	add    $0x24,%esp
80107fdc:	5b                   	pop    %ebx
80107fdd:	5d                   	pop    %ebp
80107fde:	c3                   	ret    
...
80107fe2:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107fea:	79 0a                	jns    80107ff6 <allocuvm+0x17>
    return 0;
80107fec:	b8 00 00 00 00       	mov    $0x0,%eax
80107ff1:	e9 c1 00 00 00       	jmp    801080b7 <allocuvm+0xd8>
  if(newsz < oldsz)
80107ff6:	8b 45 10             	mov    0x10(%ebp),%eax
80107ff9:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107ffc:	73 08                	jae    80108006 <allocuvm+0x27>
    return oldsz;
80107ffe:	8b 45 0c             	mov    0xc(%ebp),%eax
80108001:	e9 b1 00 00 00       	jmp    801080b7 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108006:	8b 45 0c             	mov    0xc(%ebp),%eax
80108009:	05 ff 0f 00 00       	add    $0xfff,%eax
8010800e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108013:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108016:	e9 8d 00 00 00       	jmp    801080a8 <allocuvm+0xc9>
    mem = kalloc();
8010801b:	e8 df aa ff ff       	call   80102aff <kalloc>
80108020:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108023:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108027:	75 2c                	jne    80108055 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108029:	c7 04 24 2d 8b 10 80 	movl   $0x80108b2d,(%esp)
80108030:	e8 6c 83 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108035:	8b 45 0c             	mov    0xc(%ebp),%eax
80108038:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108049:	e8 6b 00 00 00       	call   801080b9 <deallocuvm>
      return 0;
8010804e:	b8 00 00 00 00       	mov    $0x0,%eax
80108053:	eb 62                	jmp    801080b7 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
8010806b:	e8 f6 cf ff ff       	call   80105066 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108070:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108073:	89 04 24             	mov    %eax,(%esp)
80108076:	e8 d8 f5 ff ff       	call   80107653 <v2p>
8010807b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010807e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108085:	00 
...
8010809c:	e8 d8 fa ff ff       	call   80107b79 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801080a1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801080a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ab:	3b 45 10             	cmp    0x10(%ebp),%eax
801080ae:	0f 82 67 ff ff ff    	jb     8010801b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801080bc:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
801080c5:	72 08                	jb     801080cf <deallocuvm+0x16>
    return oldsz;
801080c7:	8b 45 0c             	mov    0xc(%ebp),%eax
801080ca:	e9 a4 00 00 00       	jmp    80108173 <deallocuvm+0xba>
...
801080df:	e9 80 00 00 00       	jmp    80108164 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801080e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080e7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080ee:	00 
801080ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801080f3:	8b 45 08             	mov    0x8(%ebp),%eax
801080f6:	89 04 24             	mov    %eax,(%esp)
801080f9:	e8 e5 f9 ff ff       	call   80107ae3 <walkpgdir>
801080fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108101:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108105:	75 09                	jne    80108110 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108107:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010810e:	eb 4d                	jmp    8010815d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108110:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108113:	8b 00                	mov    (%eax),%eax
80108115:	83 e0 01             	and    $0x1,%eax
80108118:	84 c0                	test   %al,%al
8010811a:	74 41                	je     8010815d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010811c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010811f:	8b 00                	mov    (%eax),%eax
80108121:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108126:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108129:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010812d:	75 0c                	jne    8010813b <deallocuvm+0x82>
        panic("kfree");
8010812f:	c7 04 24 45 8b 10 80 	movl   $0x80108b45,(%esp)
80108136:	e8 02 84 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010813b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010813e:	89 04 24             	mov    %eax,(%esp)
80108141:	e8 1a f5 ff ff       	call   80107660 <p2v>
80108146:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108149:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010814c:	89 04 24             	mov    %eax,(%esp)
8010814f:	e8 12 a9 ff ff       	call   80102a66 <kfree>
      *pte = 0;
80108154:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108157:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010815d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108164:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108167:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010816a:	0f 82 74 ff ff ff    	jb     801080e4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108178:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010817b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010817f:	75 0c                	jne    8010818d <freevm+0x18>
    panic("freevm: no pgdir");
80108181:	c7 04 24 4b 8b 10 80 	movl   $0x80108b4b,(%esp)
80108188:	e8 b0 83 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010818d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108194:	00 
80108195:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010819c:	80 
8010819d:	8b 45 08             	mov    0x8(%ebp),%eax
801081a0:	89 04 24             	mov    %eax,(%esp)
801081a3:	e8 11 ff ff ff       	call   801080b9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801081a8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801081af:	eb 3c                	jmp    801081ed <freevm+0x78>
    if(pgdir[i] & PTE_P){
801081b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b4:	c1 e0 02             	shl    $0x2,%eax
801081b7:	03 45 08             	add    0x8(%ebp),%eax
801081ba:	8b 00                	mov    (%eax),%eax
801081bc:	83 e0 01             	and    $0x1,%eax
801081bf:	84 c0                	test   %al,%al
801081c1:	74 26                	je     801081e9 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801081c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c6:	c1 e0 02             	shl    $0x2,%eax
801081c9:	03 45 08             	add    0x8(%ebp),%eax
801081cc:	8b 00                	mov    (%eax),%eax
801081ce:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081d3:	89 04 24             	mov    %eax,(%esp)
801081d6:	e8 85 f4 ff ff       	call   80107660 <p2v>
801081db:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801081de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081e1:	89 04 24             	mov    %eax,(%esp)
801081e4:	e8 7d a8 ff ff       	call   80102a66 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801081e9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801081ed:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801081f4:	76 bb                	jbe    801081b1 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801081fc:	e8 65 a8 ff ff       	call   80102a66 <kfree>
}
80108201:	c9                   	leave  
80108202:	c3                   	ret    
...
80108206:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108209:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108210:	00 
80108211:	8b 45 0c             	mov    0xc(%ebp),%eax
80108214:	89 44 24 04          	mov    %eax,0x4(%esp)
80108218:	8b 45 08             	mov    0x8(%ebp),%eax
8010821b:	89 04 24             	mov    %eax,(%esp)
8010821e:	e8 c0 f8 ff ff       	call   80107ae3 <walkpgdir>
80108223:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108226:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010822a:	75 0c                	jne    80108238 <clearpteu+0x35>
    panic("clearpteu");
8010822c:	c7 04 24 5c 8b 10 80 	movl   $0x80108b5c,(%esp)
80108233:	e8 05 83 ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108238:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010823b:	8b 00                	mov    (%eax),%eax
8010823d:	89 c2                	mov    %eax,%edx
8010823f:	83 e2 fb             	and    $0xfffffffb,%edx
80108242:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108245:	89 10                	mov    %edx,(%eax)
}
80108247:	c9                   	leave  
80108248:	c3                   	ret    
...
8010824c:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010824f:	e8 b9 f9 ff ff       	call   80107c0d <setupkvm>
80108254:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108257:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010825b:	75 0a                	jne    80108267 <copyuvm+0x1e>
    return 0;
8010825d:	b8 00 00 00 00       	mov    $0x0,%eax
80108262:	e9 f1 00 00 00       	jmp    80108358 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
80108267:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010826e:	e9 c0 00 00 00       	jmp    80108333 <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108273:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108276:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010827d:	00 
8010827e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108282:	8b 45 08             	mov    0x8(%ebp),%eax
80108285:	89 04 24             	mov    %eax,(%esp)
80108288:	e8 56 f8 ff ff       	call   80107ae3 <walkpgdir>
8010828d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108290:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108294:	75 0c                	jne    801082a2 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108296:	c7 04 24 66 8b 10 80 	movl   $0x80108b66,(%esp)
8010829d:	e8 9b 82 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
801082a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082a5:	8b 00                	mov    (%eax),%eax
801082a7:	83 e0 01             	and    $0x1,%eax
801082aa:	85 c0                	test   %eax,%eax
801082ac:	75 0c                	jne    801082ba <copyuvm+0x71>
      panic("copyuvm: page not present");
801082ae:	c7 04 24 80 8b 10 80 	movl   $0x80108b80,(%esp)
801082b5:	e8 83 82 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801082ba:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082bd:	8b 00                	mov    (%eax),%eax
801082bf:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801082c4:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
801082c7:	e8 33 a8 ff ff       	call   80102aff <kalloc>
801082cc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801082cf:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801082d3:	74 6f                	je     80108344 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801082d5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082d8:	89 04 24             	mov    %eax,(%esp)
801082db:	e8 80 f3 ff ff       	call   80107660 <p2v>
...
801082f2:	e8 42 ce ff ff       	call   80105139 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
801082f7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801082fa:	89 04 24             	mov    %eax,(%esp)
801082fd:	e8 51 f3 ff ff       	call   80107653 <v2p>
80108302:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
80108318:	00 
80108319:	89 54 24 04          	mov    %edx,0x4(%esp)
8010831d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108320:	89 04 24             	mov    %eax,(%esp)
80108323:	e8 51 f8 ff ff       	call   80107b79 <mappages>
80108328:	85 c0                	test   %eax,%eax
8010832a:	78 1b                	js     80108347 <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010832c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108336:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108339:	0f 82 34 ff ff ff    	jb     80108273 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108342:	eb 14                	jmp    80108358 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108344:	90                   	nop
80108345:	eb 01                	jmp    80108348 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108347:	90                   	nop
...
8010834e:	e8 22 fe ff ff       	call   80108175 <freevm>
  return 0;
...
80108375:	e8 69 f7 ff ff       	call   80107ae3 <walkpgdir>
...
801083b0:	e8 ab f2 ff ff       	call   80107660 <p2v>
}
801083b5:	c9                   	leave  
801083b6:	c3                   	ret    
...
801083c0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801083c3:	e9 8b 00 00 00       	jmp    80108453 <copyout+0x9c>
...
801083e0:	e8 75 ff ff ff       	call   8010835a <uva2ka>
801083e5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801083e8:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801083ec:	75 07                	jne    801083f5 <copyout+0x3e>
      return -1;
801083ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083f3:	eb 6d                	jmp    80108462 <copyout+0xab>
    n = PGSIZE - (va - va0);
801083f5:	8b 45 0c             	mov    0xc(%ebp),%eax
801083f8:	8b 55 ec             	mov    -0x14(%ebp),%edx
801083fb:	89 d1                	mov    %edx,%ecx
801083fd:	29 c1                	sub    %eax,%ecx
801083ff:	89 c8                	mov    %ecx,%eax
80108401:	05 00 10 00 00       	add    $0x1000,%eax
80108406:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108409:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010840c:	3b 45 14             	cmp    0x14(%ebp),%eax
8010840f:	76 06                	jbe    80108417 <copyout+0x60>
      n = len;
80108411:	8b 45 14             	mov    0x14(%ebp),%eax
80108414:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108417:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010841a:	8b 55 0c             	mov    0xc(%ebp),%edx
8010841d:	89 d1                	mov    %edx,%ecx
8010841f:	29 c1                	sub    %eax,%ecx
80108421:	89 c8                	mov    %ecx,%eax
80108423:	03 45 e8             	add    -0x18(%ebp),%eax
80108426:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108429:	89 54 24 08          	mov    %edx,0x8(%esp)
8010842d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108430:	89 54 24 04          	mov    %edx,0x4(%esp)
80108434:	89 04 24             	mov    %eax,(%esp)
80108437:	e8 fd cc ff ff       	call   80105139 <memmove>
    len -= n;
...
80108457:	0f 85 6b ff ff ff    	jne    801083c8 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
