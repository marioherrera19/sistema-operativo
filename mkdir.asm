...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 46 08 00 	movl   $0x846,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 90 6c 08 00 00 	movzbl 0x86c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 55e:	75 27                	jne    587 <printf+0x120>
          s = "(null)";
 560:	c7 45 f4 62 08 00 00 	movl   $0x862,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62f:	a1 88 08 00 00       	mov    0x888,%eax
...
free(void *ap)
{
 ...
 6f0:	a3 88 08 00 00       	mov    %eax,0x888
}
 6f5:	c9                   	leave  
 6f6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 743:	e8 d8 fe ff ff       	call   620 <free>
  return freep;
 748:	a1 88 08 00 00       	mov    0x888,%eax
}
 74d:	c9                   	leave  
 74e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 761:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 764:	a1 88 08 00 00       	mov    0x888,%eax
 769:	89 45 f0             	mov    %eax,-0x10(%ebp)
 76c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 770:	75 23                	jne    795 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 772:	c7 45 f0 80 08 00 00 	movl   $0x880,-0x10(%ebp)
 779:	8b 45 f0             	mov    -0x10(%ebp),%eax
 77c:	a3 88 08 00 00       	mov    %eax,0x888
 781:	a1 88 08 00 00       	mov    0x888,%eax
 786:	a3 80 08 00 00       	mov    %eax,0x880
    base.s.size = 0;
 78b:	c7 05 84 08 00 00 00 	movl   $0x0,0x884
 792:	00 00 00 
  }
 ...
 7e8:	a3 88 08 00 00       	mov    %eax,0x888
      return (void*)(p + 1);
 ...
 7f3:	eb 38                	jmp    82d <malloc+0xde>
    ...
    if(p == freep)
 7f5:	a1 88 08 00 00       	mov    0x888,%eax
