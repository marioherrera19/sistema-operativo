...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 34 04 00 	movl   $0x434,0x4(%esp)
  36:	00 
  ...
  6b:	e8 b4 03 00 00       	call   424 <procstat>
{
  ...
  90:	00 
  91:	c7 44 24 04 40 04 00 	movl   $0x440,0x4(%esp)
  98:	00 
  ...
  b3:	c7 44 24 04 5f 04 00 	movl   $0x45f,0x4(%esp)
  ba:	00 
  ...
  e0:	c7 44 24 04 73 04 00 	movl   $0x473,0x4(%esp)
  e7:	00 
  ...
  f9:	c7 44 24 04 86 04 00 	movl   $0x486,0x4(%esp)
 100:	00 
